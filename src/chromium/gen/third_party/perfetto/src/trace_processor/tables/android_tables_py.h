  ...
  struct Row : public macros_internal::RootParentTable::Row {
    Row(int64_t in_ts = {},
        ...
        : macros_internal::RootParentTable::Row(),
          ...
          tag(in_tag),
          msg(in_msg) {
      type_ = "__intrinsic_android_logs";
    }
    int64_t ts;
    uint32_t utid;
    uint32_t prio;
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,event_id_storage_layer_,ts_storage_layer_,arg_set_id_storage_layer_,base64_proto_storage_layer_,base64_proto_id_storage_layer_},
...
class AndroidInputEventDispatchTable : public macros_internal::MacroTable {
 public:
  ...
  struct ColumnIndex {
    ...
    static constexpr uint32_t base64_proto = 6;
    static constexpr uint32_t base64_proto_id = 7;
  };
  struct ColumnType {
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,event_id_storage_layer_,arg_set_id_storage_layer_,vsync_id_storage_layer_,window_id_storage_layer_,base64_proto_storage_layer_,base64_proto_id_storage_layer_},
      {{},{},{},{},{},{},{},base64_proto_id_null_layer_});
  }
