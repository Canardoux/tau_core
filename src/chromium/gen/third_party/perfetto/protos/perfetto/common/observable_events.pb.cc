...
PROTOBUF_CONSTEXPR ObservableEvents_CloneTriggerHit::ObservableEvents_CloneTriggerHit(
  ...
  , /*decltype(_impl_.boot_time_ns_)*/uint64_t{0u}
  , /*decltype(_impl_.producer_uid_)*/0u} {}
...
class ObservableEvents_CloneTriggerHit::_Internal {
 public:
  ...
  static void set_has_producer_uid(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static void set_has_boot_time_ns(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
};
...
ObservableEvents_CloneTriggerHit::ObservableEvents_CloneTriggerHit(const ObservableEvents_CloneTriggerHit& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.boot_time_ns_){}
    , decltype(_impl_.producer_uid_){}};
  ...
  ::memcpy(&_impl_.tracing_session_id_, &from._impl_.tracing_session_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.producer_uid_) -
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _Internal::set_has_producer_uid(&has_bits);
          _impl_.producer_uid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_boot_time_ns(&has_bits);
          _impl_.boot_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ObservableEvents_CloneTriggerHit::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(4, this->_internal_producer_uid(), target);
  }

  // optional uint64 boot_time_ns = 5;
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(5, this->_internal_boot_time_ns(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.ObservableEvents.CloneTriggerHit)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional uint64 boot_time_ns = 5;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_boot_time_ns());
    }

    // optional uint32 producer_uid = 4;
    if (cached_has_bits & 0x00000010u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_producer_uid());
    }
