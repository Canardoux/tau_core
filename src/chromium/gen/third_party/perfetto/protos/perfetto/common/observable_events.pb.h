...
class ObservableEvents_CloneTriggerHit final :
 ...
 public:
  ...
  private:
  bool _internal_has_boot_time_ns() const;
  public:
  ...
  private:
  bool _internal_has_producer_uid() const;
  public:
...
// optional string producer_name = 3;
inline bool ObservableEvents_CloneTriggerHit::_internal_has_producer_name() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ObservableEvents_CloneTriggerHit::set_producer_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.producer_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:perfetto.protos.ObservableEvents.CloneTriggerHit.producer_name)
}
inline std::string* ObservableEvents_CloneTriggerHit::mutable_producer_name() {
  std::string* _s = _internal_mutable_producer_name();
...
inline std::string* ObservableEvents_CloneTriggerHit::_internal_mutable_producer_name() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.producer_name_.Mutable(GetArenaForAllocation());
}
inline std::string* ObservableEvents_CloneTriggerHit::release_producer_name() {
...
inline void ObservableEvents_CloneTriggerHit::set_allocated_producer_name(std::string* producer_name) {
  if (producer_name != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
...
// optional uint32 producer_uid = 4;
inline bool ObservableEvents_CloneTriggerHit::_internal_has_producer_uid() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool ObservableEvents_CloneTriggerHit::has_producer_uid() const {
  return _internal_has_producer_uid();
}
...
// optional uint64 boot_time_ns = 5;
inline bool ObservableEvents_CloneTriggerHit::_internal_has_boot_time_ns() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool ObservableEvents_CloneTriggerHit::has_boot_time_ns() const {
  return _internal_has_boot_time_ns();
}
