...
template<> ::perfetto::protos::FtraceConfig_KprobeEvent* Arena::CreateMaybeMessage<::perfetto::protos::FtraceConfig_KprobeEvent>(Arena*);
...
bool FtraceConfig_KprobeEvent_KprobeType_IsValid(int value);
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent_KprobeType_KprobeType_MIN = FtraceConfig_KprobeEvent_KprobeType_KPROBE_TYPE_UNKNOWN;
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent_KprobeType_KprobeType_MAX = FtraceConfig_KprobeEvent_KprobeType_KPROBE_TYPE_BOTH;
constexpr int FtraceConfig_KprobeEvent_KprobeType_KprobeType_ARRAYSIZE = FtraceConfig_KprobeEvent_KprobeType_KprobeType_MAX + 1;

const std::string& FtraceConfig_KprobeEvent_KprobeType_Name(FtraceConfig_KprobeEvent_KprobeType value);
template<typename T>
inline const std::string& FtraceConfig_KprobeEvent_KprobeType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, FtraceConfig_KprobeEvent_KprobeType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function FtraceConfig_KprobeEvent_KprobeType_Name.");
  return FtraceConfig_KprobeEvent_KprobeType_Name(static_cast<FtraceConfig_KprobeEvent_KprobeType>(enum_t_value));
}
bool FtraceConfig_KprobeEvent_KprobeType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, FtraceConfig_KprobeEvent_KprobeType* value);
...
class FtraceConfig_KprobeEvent final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:perfetto.protos.FtraceConfig.KprobeEvent) */ {
 public:
  inline FtraceConfig_KprobeEvent() : FtraceConfig_KprobeEvent(nullptr) {}
  ~FtraceConfig_KprobeEvent() override;
  explicit PROTOBUF_CONSTEXPR FtraceConfig_KprobeEvent(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  FtraceConfig_KprobeEvent(const FtraceConfig_KprobeEvent& from);
  FtraceConfig_KprobeEvent(FtraceConfig_KprobeEvent&& from) noexcept
  ...
  static inline const FtraceConfig_KprobeEvent* internal_default_instance() {
  ...
  friend void swap(FtraceConfig_KprobeEvent& a, FtraceConfig_KprobeEvent& b) {
    a.Swap(&b);
  }
  PROTOBUF_NOINLINE void Swap(FtraceConfig_KprobeEvent* other) {
  ...
  void UnsafeArenaSwap(FtraceConfig_KprobeEvent* other) {
    if (other == this) return;
  ...
  FtraceConfig_KprobeEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<FtraceConfig_KprobeEvent>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
  void CopyFrom(const FtraceConfig_KprobeEvent& from);
  void MergeFrom(const FtraceConfig_KprobeEvent& from);
  ...
  void InternalSwap(FtraceConfig_KprobeEvent* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "perfetto.protos.FtraceConfig.KprobeEvent";
  }
  protected:
  explicit FtraceConfig_KprobeEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  typedef FtraceConfig_KprobeEvent_KprobeType KprobeType;
  static constexpr KprobeType KPROBE_TYPE_UNKNOWN =
    FtraceConfig_KprobeEvent_KprobeType_KPROBE_TYPE_UNKNOWN;
  static constexpr KprobeType KPROBE_TYPE_KPROBE =
    FtraceConfig_KprobeEvent_KprobeType_KPROBE_TYPE_KPROBE;
  static constexpr KprobeType KPROBE_TYPE_KRETPROBE =
    FtraceConfig_KprobeEvent_KprobeType_KPROBE_TYPE_KRETPROBE;
  static constexpr KprobeType KPROBE_TYPE_BOTH =
    FtraceConfig_KprobeEvent_KprobeType_KPROBE_TYPE_BOTH;
  static inline bool KprobeType_IsValid(int value) {
    return FtraceConfig_KprobeEvent_KprobeType_IsValid(value);
  }
  static constexpr KprobeType KprobeType_MIN =
    FtraceConfig_KprobeEvent_KprobeType_KprobeType_MIN;
  static constexpr KprobeType KprobeType_MAX =
    FtraceConfig_KprobeEvent_KprobeType_KprobeType_MAX;
  static constexpr int KprobeType_ARRAYSIZE =
    FtraceConfig_KprobeEvent_KprobeType_KprobeType_ARRAYSIZE;
  template<typename T>
  static inline const std::string& KprobeType_Name(T enum_t_value) {
    static_assert(::std::is_same<T, KprobeType>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function KprobeType_Name.");
    return FtraceConfig_KprobeEvent_KprobeType_Name(enum_t_value);
  }
  static inline bool KprobeType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      KprobeType* value) {
  ...
  void set_probe(ArgT0&& arg0, ArgT... args);
  std::string* mutable_probe();
  PROTOBUF_NODISCARD std::string* release_probe();
  void set_allocated_probe(std::string* probe);
  private:
  const std::string& _internal_probe() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_probe(const std::string& value);
  std::string* _internal_mutable_probe();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr probe_;
    int type_;
  };
  union { Impl_ _impl_; };
...
class FtraceConfig final :
 ...
 public:
  ...
  typedef FtraceConfig_KprobeEvent KprobeEvent;
  ...
  ::perfetto::protos::FtraceConfig_KprobeEvent* mutable_kprobe_events(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::perfetto::protos::FtraceConfig_KprobeEvent >*
      mutable_kprobe_events();
  private:
  const ::perfetto::protos::FtraceConfig_KprobeEvent& _internal_kprobe_events(int index) const;
  ::perfetto::protos::FtraceConfig_KprobeEvent* _internal_add_kprobe_events();
  public:
  const ::perfetto::protos::FtraceConfig_KprobeEvent& kprobe_events(int index) const;
  ::perfetto::protos::FtraceConfig_KprobeEvent* add_kprobe_events();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::perfetto::protos::FtraceConfig_KprobeEvent >&
      kprobe_events() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::perfetto::protos::FtraceConfig_KprobeEvent > kprobe_events_;
...
// optional string probe = 1;
inline bool FtraceConfig_KprobeEvent::_internal_has_probe() const {
...
void FtraceConfig_KprobeEvent::set_probe(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.probe_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:perfetto.protos.FtraceConfig.KprobeEvent.probe)
}
inline std::string* FtraceConfig_KprobeEvent::mutable_probe() {
...
inline void FtraceConfig_KprobeEvent::_internal_set_probe(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.probe_.Set(value, GetArenaForAllocation());
}
inline std::string* FtraceConfig_KprobeEvent::_internal_mutable_probe() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.probe_.Mutable(GetArenaForAllocation());
}
inline std::string* FtraceConfig_KprobeEvent::release_probe() {
  // @@protoc_insertion_point(field_release:perfetto.protos.FtraceConfig.KprobeEvent.probe)
  if (!_internal_has_probe()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.probe_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.probe_.IsDefault()) {
    _impl_.probe_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void FtraceConfig_KprobeEvent::set_allocated_probe(std::string* probe) {
  if (probe != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  _impl_.probe_.SetAllocated(probe, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.probe_.IsDefault()) {
    _impl_.probe_.Set("", GetArenaForAllocation());
  }
...
// optional .perfetto.protos.FtraceConfig.KprobeEvent.KprobeType type = 2;
inline bool FtraceConfig_KprobeEvent::_internal_has_type() const {
...
inline void FtraceConfig_KprobeEvent::_internal_set_type(::perfetto::protos::FtraceConfig_KprobeEvent_KprobeType value) {
  assert(::perfetto::protos::FtraceConfig_KprobeEvent_KprobeType_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.type_ = value;
}
...
inline int FtraceConfig::_internal_kprobe_events_size() const {
  return _impl_.kprobe_events_.size();
}
...
inline ::perfetto::protos::FtraceConfig_KprobeEvent* FtraceConfig::mutable_kprobe_events(int index) {
  // @@protoc_insertion_point(field_mutable:perfetto.protos.FtraceConfig.kprobe_events)
  return _impl_.kprobe_events_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::perfetto::protos::FtraceConfig_KprobeEvent >*
FtraceConfig::mutable_kprobe_events() {
  // @@protoc_insertion_point(field_mutable_list:perfetto.protos.FtraceConfig.kprobe_events)
  return &_impl_.kprobe_events_;
}
inline const ::perfetto::protos::FtraceConfig_KprobeEvent& FtraceConfig::_internal_kprobe_events(int index) const {
  return _impl_.kprobe_events_.Get(index);
}
inline const ::perfetto::protos::FtraceConfig_KprobeEvent& FtraceConfig::kprobe_events(int index) const {
  ...
  return _internal_kprobe_events(index);
}
inline ::perfetto::protos::FtraceConfig_KprobeEvent* FtraceConfig::_internal_add_kprobe_events() {
  return _impl_.kprobe_events_.Add();
}
inline ::perfetto::protos::FtraceConfig_KprobeEvent* FtraceConfig::add_kprobe_events() {
  ::perfetto::protos::FtraceConfig_KprobeEvent* _add = _internal_add_kprobe_events();
  // @@protoc_insertion_point(field_add:perfetto.protos.FtraceConfig.kprobe_events)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::perfetto::protos::FtraceConfig_KprobeEvent >&
FtraceConfig::kprobe_events() const {
...
template <> struct is_proto_enum< ::perfetto::protos::FtraceConfig_KprobeEvent_KprobeType> : ::std::true_type {};
