...
namespace perfetto {
namespace protos {
PROTOBUF_CONSTEXPR FtraceConfig_KprobeEvent::FtraceConfig_KprobeEvent(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.probe_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.type_)*/0} {}
struct FtraceConfig_KprobeEventDefaultTypeInternal {
  PROTOBUF_CONSTEXPR FtraceConfig_KprobeEventDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FtraceConfig_KprobeEventDefaultTypeInternal _FtraceConfig_KprobeEvent_default_instance_;
...
PROTOBUF_CONSTEXPR FtraceConfig::FtraceConfig(
  ...
  , /*decltype(_impl_.kprobe_events_)*/{}
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> FtraceConfig_KprobeEvent_KprobeType_strings[4] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry FtraceConfig_KprobeEvent_KprobeType_entries[] = {
...
const std::string& FtraceConfig_KprobeEvent_KprobeType_Name(
    FtraceConfig_KprobeEvent_KprobeType value) {
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          FtraceConfig_KprobeEvent_KprobeType_entries,
          FtraceConfig_KprobeEvent_KprobeType_entries_by_number,
          4, FtraceConfig_KprobeEvent_KprobeType_strings);
  (void) dummy;
  ...
  return idx == -1 ? ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyString() :
                     FtraceConfig_KprobeEvent_KprobeType_strings[idx].get();
}
...
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent::KPROBE_TYPE_UNKNOWN;
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent::KPROBE_TYPE_KPROBE;
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent::KPROBE_TYPE_KRETPROBE;
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent::KPROBE_TYPE_BOTH;
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent::KprobeType_MIN;
constexpr FtraceConfig_KprobeEvent_KprobeType FtraceConfig_KprobeEvent::KprobeType_MAX;
constexpr int FtraceConfig_KprobeEvent::KprobeType_ARRAYSIZE;
...
class FtraceConfig_KprobeEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<FtraceConfig_KprobeEvent>()._impl_._has_bits_);
...
FtraceConfig_KprobeEvent::FtraceConfig_KprobeEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:perfetto.protos.FtraceConfig.KprobeEvent)
}
FtraceConfig_KprobeEvent::FtraceConfig_KprobeEvent(const FtraceConfig_KprobeEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  FtraceConfig_KprobeEvent* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  _impl_.probe_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.probe_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_probe()) {
    _this->_impl_.probe_.Set(from._internal_probe(), 
...
inline void FtraceConfig_KprobeEvent::SharedCtor(
...
inline void FtraceConfig_KprobeEvent::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.probe_.Destroy();
}

void FtraceConfig_KprobeEvent::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void FtraceConfig_KprobeEvent::Clear() {
...
const char* FtraceConfig_KprobeEvent::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_probe();
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::perfetto::protos::FtraceConfig_KprobeEvent_KprobeType_IsValid(val))) {
            _internal_set_type(static_cast<::perfetto::protos::FtraceConfig_KprobeEvent_KprobeType>(val));
          } else {
...
uint8_t* FtraceConfig_KprobeEvent::_InternalSerialize(
...
void FtraceConfig_KprobeEvent::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const FtraceConfig_KprobeEvent*>(
      &from));
}

void FtraceConfig_KprobeEvent::MergeFrom(const FtraceConfig_KprobeEvent& from) {
...
bool FtraceConfig_KprobeEvent::IsInitialized() const {
  return true;
}

void FtraceConfig_KprobeEvent::InternalSwap(FtraceConfig_KprobeEvent* other) {
  using std::swap;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.probe_, lhs_arena,
      &other->_impl_.probe_, rhs_arena
  );
  swap(_impl_.type_, other->_impl_.type_);
}

std::string FtraceConfig_KprobeEvent::GetTypeName() const {
...
FtraceConfig::FtraceConfig(const FtraceConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.kprobe_events_){from._impl_.kprobe_events_}
...
inline void FtraceConfig::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.kprobe_events_){arena}
    , decltype(_impl_.instance_name_){}
    , decltype(_impl_.compact_sched_){nullptr}
    , decltype(_impl_.print_filter_){nullptr}
    , decltype(_impl_.buffer_size_kb_){0u}
...
inline void FtraceConfig::SharedDtor() {
  ...
  _impl_.kprobe_events_.~RepeatedPtrField();
    ...
    switch (tag >> 3) {
      ...
      case 30:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 242)) {
          ...
          do {
            ptr += 2;
            ptr = ctx->ParseMessage(_internal_add_kprobe_events(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* FtraceConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00004000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(29, this->_internal_drain_buffer_percent(), target);
  }

  // repeated .perfetto.protos.FtraceConfig.KprobeEvent kprobe_events = 30;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_kprobe_events_size()); i < n; i++) {
    const auto& repfield = this->_internal_kprobe_events(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.FtraceConfig)
  ...
  // repeated .perfetto.protos.FtraceConfig.KprobeEvent kprobe_events = 30;
  total_size += 2UL * this->_internal_kprobe_events_size();
  for (const auto& msg : this->_impl_.kprobe_events_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void FtraceConfig::MergeFrom(const FtraceConfig& from) {
  ...
  _this->_impl_.kprobe_events_.MergeFrom(from._impl_.kprobe_events_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::FtraceConfig_KprobeEvent*
Arena::CreateMaybeMessage< ::perfetto::protos::FtraceConfig_KprobeEvent >(Arena* arena) {
  return Arena::CreateMessageInternal< ::perfetto::protos::FtraceConfig_KprobeEvent >(arena);
}
