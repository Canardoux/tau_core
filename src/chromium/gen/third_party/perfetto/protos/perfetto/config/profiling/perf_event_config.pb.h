...
constexpr PerfEventConfig_UnwindMode PerfEventConfig_UnwindMode_UnwindMode_MAX = PerfEventConfig_UnwindMode_UNWIND_FRAME_POINTER;
...
class PerfEventConfig_CallstackSampling final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PerfEventConfig_CallstackSampling* other) {
...
class PerfEventConfig_Scope final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PerfEventConfig_Scope* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class PerfEventConfig final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PerfEventConfig* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  static constexpr UnwindMode UNWIND_FRAME_POINTER =
    PerfEventConfig_UnwindMode_UNWIND_FRAME_POINTER;
