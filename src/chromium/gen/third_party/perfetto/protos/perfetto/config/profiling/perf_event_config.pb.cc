...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> PerfEventConfig_UnwindMode_strings[4] = {};
...
const std::string& PerfEventConfig_UnwindMode_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          4, PerfEventConfig_UnwindMode_strings);
  (void) dummy;
...
constexpr PerfEventConfig_UnwindMode PerfEventConfig::UNWIND_FRAME_POINTER;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.PerfEventConfig)
  ...
  // repeated .perfetto.protos.FollowerEvent followers = 19;
  total_size += 2UL * this->_internal_followers_size();
