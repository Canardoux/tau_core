...
PROTOBUF_CONSTEXPR DataSourceConfig::DataSourceConfig(
  ...
  , /*decltype(_impl_.windowmanager_config_)*/nullptr
  , /*decltype(_impl_.chromium_system_metrics_)*/nullptr
...
class DataSourceConfig::_Internal {
 public:
  ...
  static const ::perfetto::protos::WindowManagerConfig& windowmanager_config(const DataSourceConfig* msg);
  static void set_has_windowmanager_config(HasBits* has_bits) {
    (*has_bits)[0] |= 2147483648u;
  }
  static const ::perfetto::protos::ChromiumSystemMetricsConfig& chromium_system_metrics(const DataSourceConfig* msg);
  static void set_has_chromium_system_metrics(HasBits* has_bits) {
    (*has_bits)[1] |= 1u;
  }
...
const ::perfetto::protos::WindowManagerConfig&
DataSourceConfig::_Internal::windowmanager_config(const DataSourceConfig* msg) {
  return *msg->_impl_.windowmanager_config_;
}
const ::perfetto::protos::ChromiumSystemMetricsConfig&
DataSourceConfig::_Internal::chromium_system_metrics(const DataSourceConfig* msg) {
  return *msg->_impl_.chromium_system_metrics_;
}
...
DataSourceConfig::DataSourceConfig(const DataSourceConfig& from)
  ...
  if (from._internal_has_windowmanager_config()) {
    _this->_impl_.windowmanager_config_ = new ::perfetto::protos::WindowManagerConfig(*from._impl_.windowmanager_config_);
  }
  if (from._internal_has_chromium_system_metrics()) {
    _this->_impl_.chromium_system_metrics_ = new ::perfetto::protos::ChromiumSystemMetricsConfig(*from._impl_.chromium_system_metrics_);
  }
...
inline void DataSourceConfig::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.windowmanager_config_;
  if (this != internal_default_instance()) delete _impl_.chromium_system_metrics_;
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.DataSourceConfig)
  ...
  if (cached_has_bits & 0xff000000u) {
    ...
    if (cached_has_bits & 0x80000000u) {
      GOOGLE_DCHECK(_impl_.windowmanager_config_ != nullptr);
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      GOOGLE_DCHECK(_impl_.chromium_system_metrics_ != nullptr);
  ...
  if (cached_has_bits & 0x000000fcu) {
    ::memset(&_impl_.target_buffer_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.prefer_suspend_clock_for_duration_) -
        reinterpret_cast<char*>(&_impl_.target_buffer_)) + sizeof(_impl_.prefer_suspend_clock_for_duration_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 130:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_windowmanager_config(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 131:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ptr = ctx->ParseMessage(_internal_mutable_chromium_system_metrics(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* DataSourceConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x80000000u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(130, _Internal::windowmanager_config(this),
        _Internal::windowmanager_config(this).GetCachedSize(), target, stream);
  }
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(131, _Internal::chromium_system_metrics(this),
        _Internal::chromium_system_metrics(this).GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.DataSourceConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000001u) {
      total_size += 2 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(
          *_impl_.chromium_system_metrics_);
    }
...
void DataSourceConfig::MergeFrom(const DataSourceConfig& from) {
  ...
  if (cached_has_bits & 0xff000000u) {
    ...
    if (cached_has_bits & 0x80000000u) {
      _this->_internal_mutable_windowmanager_config()->::perfetto::protos::WindowManagerConfig::MergeFrom(
          from._internal_windowmanager_config());
    }
  }
  cached_has_bits = from._impl_._has_bits_[1];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_chromium_system_metrics()->::perfetto::protos::ChromiumSystemMetricsConfig::MergeFrom(
          from._internal_chromium_system_metrics());
    }
    if (cached_has_bits & 0x00000002u) {
  ...
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_enable_extra_guardrails(from._internal_enable_extra_guardrails());
  }
