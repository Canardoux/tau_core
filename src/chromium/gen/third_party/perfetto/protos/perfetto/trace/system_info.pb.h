...
class SystemInfo final :
 ...
 public:
  ...
  private:
  bool _internal_has_android_guest_soc_model() const;
  public:
  void clear_android_guest_soc_model();
  const std::string& android_guest_soc_model() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_android_guest_soc_model(ArgT0&& arg0, ArgT... args);
  std::string* mutable_android_guest_soc_model();
  PROTOBUF_NODISCARD std::string* release_android_guest_soc_model();
  void set_allocated_android_guest_soc_model(std::string* android_guest_soc_model);
  private:
  const std::string& _internal_android_guest_soc_model() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_android_guest_soc_model(const std::string& value);
  std::string* _internal_mutable_android_guest_soc_model();
  public:

  // optional string android_device_manufacturer = 14;
  bool has_android_device_manufacturer() const;
  private:
  bool _internal_has_android_device_manufacturer() const;
  public:
  void clear_android_device_manufacturer();
  const std::string& android_device_manufacturer() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_android_device_manufacturer(ArgT0&& arg0, ArgT... args);
  std::string* mutable_android_device_manufacturer();
  PROTOBUF_NODISCARD std::string* release_android_device_manufacturer();
  void set_allocated_android_device_manufacturer(std::string* android_device_manufacturer);
  private:
  const std::string& _internal_android_device_manufacturer() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_android_device_manufacturer(const std::string& value);
  std::string* _internal_mutable_android_device_manufacturer();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr android_guest_soc_model_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr android_device_manufacturer_;
...
// optional string android_device_manufacturer = 14;
inline bool SystemInfo::_internal_has_android_device_manufacturer() const {
  bool value = (_impl_._has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool SystemInfo::has_android_device_manufacturer() const {
  return _internal_has_android_device_manufacturer();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SystemInfo::set_android_device_manufacturer(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000080u;
 _impl_.android_device_manufacturer_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:perfetto.protos.SystemInfo.android_device_manufacturer)
}
inline std::string* SystemInfo::mutable_android_device_manufacturer() {
...
inline void SystemInfo::_internal_set_android_device_manufacturer(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.android_device_manufacturer_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemInfo::_internal_mutable_android_device_manufacturer() {
  _impl_._has_bits_[0] |= 0x00000080u;
  return _impl_.android_device_manufacturer_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemInfo::release_android_device_manufacturer() {
  // @@protoc_insertion_point(field_release:perfetto.protos.SystemInfo.android_device_manufacturer)
  if (!_internal_has_android_device_manufacturer()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000080u;
  auto* p = _impl_.android_device_manufacturer_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.android_device_manufacturer_.IsDefault()) {
    _impl_.android_device_manufacturer_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemInfo::set_allocated_android_device_manufacturer(std::string* android_device_manufacturer) {
  if (android_device_manufacturer != nullptr) {
    _impl_._has_bits_[0] |= 0x00000080u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000080u;
  }
  _impl_.android_device_manufacturer_.SetAllocated(android_device_manufacturer, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.android_device_manufacturer_.IsDefault()) {
    _impl_.android_device_manufacturer_.Set("", GetArenaForAllocation());
  }
...
// optional string android_guest_soc_model = 13;
inline bool SystemInfo::_internal_has_android_guest_soc_model() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool SystemInfo::has_android_guest_soc_model() const {
  return _internal_has_android_guest_soc_model();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SystemInfo::set_android_guest_soc_model(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000040u;
 _impl_.android_guest_soc_model_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:perfetto.protos.SystemInfo.android_guest_soc_model)
}
inline std::string* SystemInfo::mutable_android_guest_soc_model() {
...
inline void SystemInfo::_internal_set_android_guest_soc_model(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.android_guest_soc_model_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemInfo::_internal_mutable_android_guest_soc_model() {
  _impl_._has_bits_[0] |= 0x00000040u;
  return _impl_.android_guest_soc_model_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemInfo::release_android_guest_soc_model() {
  // @@protoc_insertion_point(field_release:perfetto.protos.SystemInfo.android_guest_soc_model)
  if (!_internal_has_android_guest_soc_model()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000040u;
  auto* p = _impl_.android_guest_soc_model_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.android_guest_soc_model_.IsDefault()) {
    _impl_.android_guest_soc_model_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemInfo::set_allocated_android_guest_soc_model(std::string* android_guest_soc_model) {
  if (android_guest_soc_model != nullptr) {
    _impl_._has_bits_[0] |= 0x00000040u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000040u;
  }
  _impl_.android_guest_soc_model_.SetAllocated(android_guest_soc_model, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.android_guest_soc_model_.IsDefault()) {
    _impl_.android_guest_soc_model_.Set("", GetArenaForAllocation());
  }
