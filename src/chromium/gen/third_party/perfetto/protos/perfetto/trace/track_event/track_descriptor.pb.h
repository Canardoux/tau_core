...
constexpr TrackDescriptor_ChildTracksOrdering TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_MIN = TrackDescriptor_ChildTracksOrdering_UNKNOWN;
constexpr TrackDescriptor_ChildTracksOrdering TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_MAX = TrackDescriptor_ChildTracksOrdering_EXPLICIT;
constexpr int TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_ARRAYSIZE = TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_MAX + 1;

const std::string& TrackDescriptor_ChildTracksOrdering_Name(TrackDescriptor_ChildTracksOrdering value);
template<typename T>
inline const std::string& TrackDescriptor_ChildTracksOrdering_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TrackDescriptor_ChildTracksOrdering>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TrackDescriptor_ChildTracksOrdering_Name.");
  return TrackDescriptor_ChildTracksOrdering_Name(static_cast<TrackDescriptor_ChildTracksOrdering>(enum_t_value));
}
...
class TrackDescriptor final :
 ...
 public:
  ...
  typedef TrackDescriptor_ChildTracksOrdering ChildTracksOrdering;
  static constexpr ChildTracksOrdering UNKNOWN =
    TrackDescriptor_ChildTracksOrdering_UNKNOWN;
  static constexpr ChildTracksOrdering LEXICOGRAPHIC =
    TrackDescriptor_ChildTracksOrdering_LEXICOGRAPHIC;
  static constexpr ChildTracksOrdering CHRONOLOGICAL =
    TrackDescriptor_ChildTracksOrdering_CHRONOLOGICAL;
  static constexpr ChildTracksOrdering EXPLICIT =
    TrackDescriptor_ChildTracksOrdering_EXPLICIT;
  static inline bool ChildTracksOrdering_IsValid(int value) {
    return TrackDescriptor_ChildTracksOrdering_IsValid(value);
  }
  static constexpr ChildTracksOrdering ChildTracksOrdering_MIN =
    TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_MIN;
  static constexpr ChildTracksOrdering ChildTracksOrdering_MAX =
    TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_MAX;
  static constexpr int ChildTracksOrdering_ARRAYSIZE =
    TrackDescriptor_ChildTracksOrdering_ChildTracksOrdering_ARRAYSIZE;
  template<typename T>
  static inline const std::string& ChildTracksOrdering_Name(T enum_t_value) {
    static_assert(::std::is_same<T, ChildTracksOrdering>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function ChildTracksOrdering_Name.");
    return TrackDescriptor_ChildTracksOrdering_Name(enum_t_value);
  }
  static inline bool ChildTracksOrdering_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      ChildTracksOrdering* value) {
  ...
  private:
  bool _internal_has_child_ordering() const;
  public:
  ...
  private:
  bool _internal_has_sibling_order_rank() const;
  public:
  ...
  private:
  bool _internal_has_atrace_name() const;
  public:
  void clear_atrace_name();
  const std::string& atrace_name() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_atrace_name(ArgT0&& arg0, ArgT... args);
  std::string* mutable_atrace_name();
  PROTOBUF_NODISCARD std::string* release_atrace_name();
  void set_allocated_atrace_name(std::string* atrace_name);
  private:
  const std::string& _internal_atrace_name() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_atrace_name(const std::string& value);
  std::string* _internal_mutable_atrace_name();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    union StaticOrDynamicNameUnion {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr atrace_name_;
...
template <typename ArgT0, typename... ArgT>
inline void TrackDescriptor::set_atrace_name(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_atrace_name()) {
    clear_static_or_dynamic_name();
    set_has_atrace_name();
    _impl_.static_or_dynamic_name_.atrace_name_.InitDefault();
  }
  _impl_.static_or_dynamic_name_.atrace_name_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:perfetto.protos.TrackDescriptor.atrace_name)
}
inline std::string* TrackDescriptor::mutable_atrace_name() {
...
inline void TrackDescriptor::_internal_set_atrace_name(const std::string& value) {
  ...
  _impl_.static_or_dynamic_name_.atrace_name_.Set(value, GetArenaForAllocation());
}
inline std::string* TrackDescriptor::_internal_mutable_atrace_name() {
  if (!_internal_has_atrace_name()) {
    clear_static_or_dynamic_name();
    set_has_atrace_name();
    _impl_.static_or_dynamic_name_.atrace_name_.InitDefault();
  }
  return _impl_.static_or_dynamic_name_.atrace_name_.Mutable(      GetArenaForAllocation());
}
inline std::string* TrackDescriptor::release_atrace_name() {
...
inline void TrackDescriptor::set_allocated_atrace_name(std::string* atrace_name) {
  if (has_static_or_dynamic_name()) {
    clear_static_or_dynamic_name();
  }
  if (atrace_name != nullptr) {
    set_has_atrace_name();
    _impl_.static_or_dynamic_name_.atrace_name_.InitAllocated(atrace_name, GetArenaForAllocation());
  }
...
// optional .perfetto.protos.TrackDescriptor.ChildTracksOrdering child_ordering = 11;
inline bool TrackDescriptor::_internal_has_child_ordering() const {
  bool value = (_impl_._has_bits_[0] & 0x00000100u) != 0;
  return value;
}
inline bool TrackDescriptor::has_child_ordering() const {
  return _internal_has_child_ordering();
}
...
inline void TrackDescriptor::_internal_set_child_ordering(::perfetto::protos::TrackDescriptor_ChildTracksOrdering value) {
  assert(::perfetto::protos::TrackDescriptor_ChildTracksOrdering_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000100u;
...
// optional int32 sibling_order_rank = 12;
inline bool TrackDescriptor::_internal_has_sibling_order_rank() const {
  bool value = (_impl_._has_bits_[0] & 0x00000200u) != 0;
  return value;
}
inline bool TrackDescriptor::has_sibling_order_rank() const {
  return _internal_has_sibling_order_rank();
}
...
template <> struct is_proto_enum< ::perfetto::protos::TrackDescriptor_ChildTracksOrdering> : ::std::true_type {};
