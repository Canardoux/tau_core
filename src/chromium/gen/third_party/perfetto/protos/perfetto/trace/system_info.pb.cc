...
PROTOBUF_CONSTEXPR SystemInfo::SystemInfo(
  ...
  , /*decltype(_impl_.android_hardware_revision_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.android_storage_model_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.android_ram_model_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.android_guest_soc_model_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.android_device_manufacturer_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
class SystemInfo::_Internal {
 public:
  ...
  static void set_has_android_device_manufacturer(HasBits* has_bits) {
    (*has_bits)[0] |= 128u;
  }
  static void set_has_android_soc_model(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_android_guest_soc_model(HasBits* has_bits) {
    (*has_bits)[0] |= 64u;
  }
  static void set_has_android_hardware_revision(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  static void set_has_android_storage_model(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static void set_has_android_ram_model(HasBits* has_bits) {
    (*has_bits)[0] |= 32u;
  }
...
SystemInfo::SystemInfo(const SystemInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.android_hardware_revision_){}
    , decltype(_impl_.android_storage_model_){}
    , decltype(_impl_.android_ram_model_){}
    , decltype(_impl_.android_guest_soc_model_){}
    , decltype(_impl_.android_device_manufacturer_){}
    , decltype(_impl_.utsname_){nullptr}
    , decltype(_impl_.hz_){}
  ...
  _impl_.android_hardware_revision_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.android_hardware_revision_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_android_hardware_revision()) {
    _this->_impl_.android_hardware_revision_.Set(from._internal_android_hardware_revision(), 
      _this->GetArenaForAllocation());
  }
  _impl_.android_storage_model_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.android_storage_model_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_android_storage_model()) {
    _this->_impl_.android_storage_model_.Set(from._internal_android_storage_model(), 
      _this->GetArenaForAllocation());
  }
  _impl_.android_ram_model_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.android_ram_model_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_android_ram_model()) {
    _this->_impl_.android_ram_model_.Set(from._internal_android_ram_model(), 
      _this->GetArenaForAllocation());
  }
  _impl_.android_guest_soc_model_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.android_guest_soc_model_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_android_guest_soc_model()) {
    _this->_impl_.android_guest_soc_model_.Set(from._internal_android_guest_soc_model(), 
      _this->GetArenaForAllocation());
  }
  _impl_.android_device_manufacturer_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.android_device_manufacturer_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_android_device_manufacturer()) {
    _this->_impl_.android_device_manufacturer_.Set(from._internal_android_device_manufacturer(), 
      _this->GetArenaForAllocation());
  }
...
inline void SystemInfo::SharedDtor() {
  ...
  _impl_.android_hardware_revision_.Destroy();
  _impl_.android_storage_model_.Destroy();
  _impl_.android_ram_model_.Destroy();
  _impl_.android_guest_soc_model_.Destroy();
  _impl_.android_device_manufacturer_.Destroy();
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 82)) {
          auto str = _internal_mutable_android_hardware_revision();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 90)) {
          auto str = _internal_mutable_android_storage_model();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 98)) {
          auto str = _internal_mutable_android_ram_model();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 106)) {
          auto str = _internal_mutable_android_guest_soc_model();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 114)) {
          auto str = _internal_mutable_android_device_manufacturer();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* SystemInfo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->WriteStringMaybeAliased(
        10, this->_internal_android_hardware_revision(), target);
  }

  // optional string android_storage_model = 11;
  if (cached_has_bits & 0x00000010u) {
    target = stream->WriteStringMaybeAliased(
        11, this->_internal_android_storage_model(), target);
  }

  // optional string android_ram_model = 12;
  if (cached_has_bits & 0x00000020u) {
    target = stream->WriteStringMaybeAliased(
        12, this->_internal_android_ram_model(), target);
  }

  // optional string android_guest_soc_model = 13;
  if (cached_has_bits & 0x00000040u) {
    target = stream->WriteStringMaybeAliased(
        13, this->_internal_android_guest_soc_model(), target);
  }

  // optional string android_device_manufacturer = 14;
  if (cached_has_bits & 0x00000080u) {
    target = stream->WriteStringMaybeAliased(
        14, this->_internal_android_device_manufacturer(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.SystemInfo)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_android_hardware_revision());
    }
    ...
    if (cached_has_bits & 0x00000010u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_android_storage_model());
    }
    ...
    if (cached_has_bits & 0x00000020u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_android_ram_model());
    }
    ...
    if (cached_has_bits & 0x00000040u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_android_guest_soc_model());
    }
    ...
    if (cached_has_bits & 0x00000080u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_android_device_manufacturer());
    }
...
void SystemInfo::InternalSwap(SystemInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.android_hardware_revision_, lhs_arena,
      &other->_impl_.android_hardware_revision_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.android_storage_model_, lhs_arena,
      &other->_impl_.android_storage_model_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.android_ram_model_, lhs_arena,
      &other->_impl_.android_ram_model_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.android_guest_soc_model_, lhs_arena,
      &other->_impl_.android_guest_soc_model_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.android_device_manufacturer_, lhs_arena,
      &other->_impl_.android_device_manufacturer_, rhs_arena
  );
