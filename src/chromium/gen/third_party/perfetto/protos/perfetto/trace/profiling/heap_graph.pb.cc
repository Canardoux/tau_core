...
PROTOBUF_CONSTEXPR HeapGraphObject::HeapGraphObject(
  ...
  , /*decltype(_impl_.heap_type_delta_)*/0
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> HeapGraphObject_HeapType_strings[4] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry HeapGraphObject_HeapType_entries[] = {
...
const std::string& HeapGraphObject_HeapType_Name(
    HeapGraphObject_HeapType value) {
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          HeapGraphObject_HeapType_entries,
          HeapGraphObject_HeapType_entries_by_number,
          4, HeapGraphObject_HeapType_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      HeapGraphObject_HeapType_entries,
      HeapGraphObject_HeapType_entries_by_number,
      4, value);
  return idx == -1 ? ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyString() :
                     HeapGraphObject_HeapType_strings[idx].get();
}
...
#if (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
constexpr HeapGraphObject_HeapType HeapGraphObject::HEAP_TYPE_UNKNOWN;
constexpr HeapGraphObject_HeapType HeapGraphObject::HEAP_TYPE_APP;
constexpr HeapGraphObject_HeapType HeapGraphObject::HEAP_TYPE_ZYGOTE;
constexpr HeapGraphObject_HeapType HeapGraphObject::HEAP_TYPE_BOOT_IMAGE;
constexpr HeapGraphObject_HeapType HeapGraphObject::HeapType_MIN;
constexpr HeapGraphObject_HeapType HeapGraphObject::HeapType_MAX;
constexpr int HeapGraphObject::HeapType_ARRAYSIZE;
#endif  // (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
...
class HeapGraphObject::_Internal {
 public:
  ...
  static void set_has_heap_type_delta(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
};
...
HeapGraphObject::HeapGraphObject(const HeapGraphObject& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.heap_type_delta_){}
    , decltype(_impl_.identifier_){}
    , /*decltype(_impl_._oneof_case_)*/{}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.type_id_, &from._impl_.type_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.heap_type_delta_) -
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::perfetto::protos::HeapGraphObject_HeapType_IsValid(val))) {
            _internal_set_heap_type_delta(static_cast<::perfetto::protos::HeapGraphObject_HeapType>(val));
          } else {
...
uint8_t* HeapGraphObject::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      9, this->_internal_heap_type_delta(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.HeapGraphObject)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_heap_type_delta());
    }
