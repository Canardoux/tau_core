 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},e=t=>(...e)=>({_$litDirective$:t,values:e});
...
class CrLitElement extends s$1 {
    $;
        ...
        if (notifyProps !== null) {
            ...
            for (const key of changedProperties.keys()) {
                if (notifyProps.has(key)) {
                    ...
                    this.fire(`${toDashCase(key.toString())}-changed`, { value: indexableThis[key] });
                }
            }
        }
    }
...
export { f as AsyncDirective, CrLitElement, s$1 as LitElement, t$1 as PartType, i$3 as css, e as directive, x as html, T as nothing, j as render };
