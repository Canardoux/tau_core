...
export var ClientFeature = /* @__PURE__ */ ((ClientFeature2) => {
  ...
  ClientFeature2[ClientFeature2["CHROME_FREESTYLER"] = 2] = "CHROME_FREESTYLER";
  ClientFeature2[ClientFeature2["CHROME_DRJONES_NETWORK_AGENT"] = 7] = "CHROME_DRJONES_NETWORK_AGENT";
  ClientFeature2[ClientFeature2["CHROME_DRJONES_PERFORMANCE_AGENT"] = 8] = "CHROME_DRJONES_PERFORMANCE_AGENT";
  ClientFeature2[ClientFeature2["CHROME_DRJONES_FILE_AGENT"] = 9] = "CHROME_DRJONES_FILE_AGENT";
      ...
      for (const result of results) {
        if ("metadata" in result) {
          ...
          if ("attributionMetadata" in result.metadata) {
            ...
            if (result.metadata.attributionMetadata.attributionAction === "BLOCK" /* BLOCK */) {
  ...
  async pollAidaAvailability() {
    ...
    if (currentAidaAvailability !== this.#aidaAvailability) {
      ...
      const config = await new Promise(
        (resolve) => InspectorFrontendHostInstance.getHostConfig((config2) => resolve(config2))
      );
