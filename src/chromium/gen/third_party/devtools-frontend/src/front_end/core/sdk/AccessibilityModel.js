...
export var CoreAxPropertyName = /* @__PURE__ */ ((CoreAxPropertyName2) => {
...
export class AccessibilityNode {
  ...
  coreProperties() {
    ...
    if (this.#nameInternal) {
      properties.push({ name: "name" /* NAME */, value: this.#nameInternal });
    }
    if (this.#descriptionInternal) {
      properties.push({ name: "description" /* DESCRIPTION */, value: this.#descriptionInternal });
    }
    if (this.#valueInternal) {
      properties.push({ name: "value" /* VALUE */, value: this.#valueInternal });
    }
    return properties;
  }
  name() {
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["TREE_UPDATED"] = "TreeUpdated";
  return Events2;
})(Events || {});
