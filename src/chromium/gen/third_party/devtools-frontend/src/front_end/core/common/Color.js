...
export class Legacy {
  ...
  #formatInternal;
  static #conversions = {
    ["hex" /* HEX */]: (self) => new Legacy(self.#rgbaInternal, "hex" /* HEX */),
    ["hexa" /* HEXA */]: (self) => new Legacy(self.#rgbaInternal, "hexa" /* HEXA */),
    ["rgb" /* RGB */]: (self) => new Legacy(self.#rgbaInternal, "rgb" /* RGB */),
    ["rgba" /* RGBA */]: (self) => new Legacy(self.#rgbaInternal, "rgba" /* RGBA */),
    ["hsl" /* HSL */]: (self) => new HSL(...rgbToHsl([self.#rgbaInternal[0], self.#rgbaInternal[1], self.#rgbaInternal[2]]), self.alpha),
    ["hsla" /* HSLA */]: (self) => new HSL(...rgbToHsl([self.#rgbaInternal[0], self.#rgbaInternal[1], self.#rgbaInternal[2]]), self.alpha),
    ["hwb" /* HWB */]: (self) => new HWB(...rgbToHwb([self.#rgbaInternal[0], self.#rgbaInternal[1], self.#rgbaInternal[2]]), self.alpha),
    ["hwba" /* HWBA */]: (self) => new HWB(...rgbToHwb([self.#rgbaInternal[0], self.#rgbaInternal[1], self.#rgbaInternal[2]]), self.alpha),
    ["lch" /* LCH */]: (self) => new LCH(...ColorConverter.labToLch(...ColorConverter.xyzd50ToLab(...self.#toXyzd50())), self.alpha),
    ["oklch" /* OKLCH */]: (self) => new Oklch(...ColorConverter.xyzd50ToOklch(...self.#toXyzd50()), self.alpha),
    ["lab" /* LAB */]: (self) => new Lab(...ColorConverter.xyzd50ToLab(...self.#toXyzd50()), self.alpha),
    ["oklab" /* OKLAB */]: (self) => new Oklab(...ColorConverter.xyzd65ToOklab(...ColorConverter.xyzd50ToD65(...self.#toXyzd50())), self.alpha),
