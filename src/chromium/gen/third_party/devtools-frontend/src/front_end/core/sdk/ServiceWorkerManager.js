...
export class ServiceWorkerManager extends SDKModel {
  ...
  constructor(target) {
    ...
    this.#enabled = false;
    void this.enable();
    this.#forceUpdateSetting = Common.Settings.Settings.instance().createSetting("service-worker-update-on-reload", false);
...
export var Events = /* @__PURE__ */ ((Events2) => {
  Events2["REGISTRATION_UPDATED"] = "RegistrationUpdated";
  Events2["REGISTRATION_ERROR_ADDED"] = "RegistrationErrorAdded";
  Events2["REGISTRATION_DELETED"] = "RegistrationDeleted";
  return Events2;
})(Events || {});
...
class ServiceWorkerContextNamer {
  ...
  constructor(target, serviceWorkerManager) {
    ...
    TargetManager.instance().addModelListener(
      RuntimeModel,
      RuntimeModelEvents.ExecutionContextCreated,
