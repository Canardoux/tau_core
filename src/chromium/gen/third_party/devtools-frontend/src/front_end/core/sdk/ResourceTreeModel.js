...
export class ResourceTreeFrame {
  ...
  constructor(model, parentFrame, frameId, payload, creationStackTrace) {
    ...
    this.#urlInternal = payload && payload.url || Platform.DevToolsPath.EmptyUrlString;
    ...
    this.#unreachableUrlInternal = payload && payload.unreachableUrl || Platform.DevToolsPath.EmptyUrlString;
  ...
  navigate(framePayload) {
    ...
    this.#unreachableUrlInternal = framePayload.unreachableUrl || Platform.DevToolsPath.EmptyUrlString;
   ...
   */
  isOutermostFrame() {
    return this.#model.target().parentTarget()?.type() !== Type.FRAME && !this.#sameTargetParentFrameInternal && !this.crossTargetParentFrameId;
  }
  /**
