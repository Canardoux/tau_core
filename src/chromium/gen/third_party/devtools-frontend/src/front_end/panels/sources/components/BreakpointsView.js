...
export class BreakpointsView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  ...
  #renderEditBreakpointButton(breakpointItem) {
    ...
    const title = breakpointItem.type === SDK.DebuggerModel.BreakpointType.LOGPOINT ? i18nString(UIStrings.editLogpoint) : i18nString(UIStrings.editCondition);
    return html`
  ...
  #renderGroupCheckbox(group) {
    ...
    const checked = group.breakpointItems.some((item) => item.status === "ENABLED" /* ENABLED */);
    return html`
