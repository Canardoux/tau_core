...
import { CoverageModel, CoverageType, Events } from "./CoverageModel.js";
...
export class CoverageView extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.coverageTypeComboBox = new UI.Toolbar.ToolbarComboBox(
      this.onCoverageTypeComboBoxSelectionChanged.bind(this),
      i18nString(UIStrings.chooseCoverageGranularityPer),
      void 0,
      "coverage-type"
    );
    const coverageTypes = [
    ...
    this.filterByTypeComboBox = new UI.Toolbar.ToolbarComboBox(
      this.onFilterByTypeChanged.bind(this),
      i18nString(UIStrings.filterCoverageByType),
      void 0,
      "coverage-by-type"
    );
    const options = [
    ...
    this.contentScriptsCheckbox = new UI.Toolbar.ToolbarSettingCheckbox(
      this.showContentScriptsSetting,
      i18nString(UIStrings.includeExtensionContentScripts),
    ...
    this.activationReloadPromptPage = this.buildReloadPromptPage(i18nString(UIStrings.activationNoCapture), "prerender-page");
  ...
  buildLandingPage() {
    ...
    if (this.startWithReloadButton) {
      ...
      message = i18n.i18n.getFormatLocalizedString(
        str_,
        UIStrings.clickTheReloadButtonSToReloadAnd,
  ...
  buildReloadPromptPage(message, className) {
    ...
    this.inlineReloadButton = UI.UIUtils.createInlineButton(UI.Toolbar.Toolbar.createActionButtonForId("inspector-main.reload"));
