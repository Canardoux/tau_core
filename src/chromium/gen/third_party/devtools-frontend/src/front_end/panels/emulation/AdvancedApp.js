...
export class AdvancedApp {
  ...
  constructor() {
    UI.DockController.DockController.instance().addEventListener(
      UI.DockController.Events.BEFORE_DOCK_SIDE_CHANGED,
  ...
  presentUI(document) {
    ...
    this.rootSplitWidget = new UI.SplitWidget.SplitWidget(false, true, "inspector-view.split-view-state", 555, 300, true);
    ...
    UI.DockController.DockController.instance().addEventListener(
      UI.DockController.Events.DOCK_SIDE_CHANGED,
  ...
  updateForDocked(dockSide) {
    ...
    this.rootSplitWidget.toggleResizer(
      ...
      dockSide === UI.DockController.DockState.BOTTOM
    );
