...
export class EntryLabelOverlay extends HTMLElement {
  ...
  #drawLabel(initialLabel) {
    ...
    if (this.#shouldDrawBelowEntry && this.#entryLabelVisibleHeight) {
      const verticalTransform = this.#entryLabelVisibleHeight + EntryLabelOverlay.LABEL_HEIGHT + EntryLabelOverlay.LABEL_PADDING * 2 + EntryLabelOverlay.LABEL_CONNECTOR_HEIGHT * 2;
