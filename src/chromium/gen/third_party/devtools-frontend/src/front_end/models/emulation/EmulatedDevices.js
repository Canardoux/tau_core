...
export class EmulatedDevice {
  ...
  constructor() {
    ...
    this.#showInternal = "Default" /* Default */;
  ...
  static fromJSONV1(json) {
    try {
      ...
      result.userAgentMetadata = parseValue2(json, "user-agent-metadata", "object", null);
  ...
  show() {
    if (this.#showInternal === "Default" /* Default */) {
      return this.#showByDefault;
    }
    return this.#showInternal === "Always" /* Always */;
  }
  setShow(show) {
    this.#showInternal = show ? "Always" /* Always */ : "Never" /* Never */;
  }
  copyShowFrom(other) {
...
export class EmulatedDevicesList extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor() {
    ...
    this.#standardInternal = /* @__PURE__ */ new Set();
    ...
    this.#customInternal = /* @__PURE__ */ new Set();
