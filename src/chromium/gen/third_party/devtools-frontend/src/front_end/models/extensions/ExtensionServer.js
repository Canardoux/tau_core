...
export class ExtensionServer extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor() {
    ...
    this.registerHandler(
      PrivateAPI.Commands.RegisterLanguageExtensionPlugin,
    ...
    this.registerHandler(
      PrivateAPI.Commands.RegisterRecorderExtensionPlugin,
  ...
  initExtensions() {
    ...
    this.registerSubscriptionHandler(
      PrivateAPI.Events.PanelObjectSelected + "elements",
  ...
  registerResourceContentCommittedHandler(handler) {
    ...
    this.registerSubscriptionHandler(
      PrivateAPI.Events.ResourceContentCommitted,
