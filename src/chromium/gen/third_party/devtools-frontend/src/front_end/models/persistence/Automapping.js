...
export class Automapping {
  ...
  constructor(workspace, onStatusAdded, onStatusRemoved) {
    ...
    this.statuses = /* @__PURE__ */ new Set();
    this.fileSystemUISourceCodes = new FileSystemUISourceCodes();
    this.sweepThrottler = new Common.Throttler.Throttler(100);
    this.sourceCodeToProcessingPromiseMap = /* @__PURE__ */ new WeakMap();
    this.sourceCodeToAutoMappingStatusMap = /* @__PURE__ */ new WeakMap();
    this.sourceCodeToMetadataMap = /* @__PURE__ */ new WeakMap();
...
class FileSystemUISourceCodes {
  sourceCodes;
  constructor() {
    this.sourceCodes = /* @__PURE__ */ new Map();
  }
