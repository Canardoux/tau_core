...
export class NetworkPersistenceManager extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(workspace) {
    ...
    this.originalResponseContentPromises = /* @__PURE__ */ new WeakMap();
    this.savingForOverrides = /* @__PURE__ */ new WeakSet();
    ...
    this.networkUISourceCodeForEncodedPath = /* @__PURE__ */ new Map();
    ...
    this.#headerOverridesForEventDispatch = /* @__PURE__ */ new Set();
  ...
  fileUrlFromNetworkUrl(url, ignoreInactive) {
    ...
    return Common.ParsedURL.ParsedURL.concatenate(
      this.projectInternal.fileSystemPath(),
      "/",
  ...
  #shouldPromptSaveForOverridesDialog(uiSourceCode) {
    return this.isUISourceCodeOverridable(uiSourceCode) && !this.#isUISourceCodeAlreadyOverridden(uiSourceCode) && !this.activeInternal && !this.projectInternal;
  }
  #canSaveUISourceCodeForOverrides(uiSourceCode) {
    return this.activeInternal && this.isUISourceCodeOverridable(uiSourceCode) && !this.#isUISourceCodeAlreadyOverridden(uiSourceCode);
  }
  ...
  async setProject(project) {
    ...
    await this.updateActiveProject();
    this.dispatchEventToListeners("ProjectChanged" /* PROJECT_CHANGED */, this.projectInternal);
  }
