...
export class EditFileSystemView extends UI.Widget.VBox {
  ...
  constructor(fileSystemPath) {
    ...
    const addButton = UI.UIUtils.createTextButton(
      ...
      this.addExcludedFolderButtonClicked.bind(this),
  ...
  commitEdit(item, editor, isNew) {
    ...
    this.getFileSystem().addExcludedFolder(
      this.normalizePrefix(editor.control("path-prefix").value)
    );
  ...
  createExcludedFolderEditor() {
    ...
    fields.createChild("div", "file-system-value").appendChild(editor.createInput("path-prefix", "text", "/path/to/folder/", pathPrefixValidator.bind(this)));
    return editor;
