...
export class WorkspaceSettingsTab extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    IsolatedFileSystemManager.instance().addEventListener(
      ...
      (event) => this.fileSystemAdded(event.data),
      this
    );
    IsolatedFileSystemManager.instance().addEventListener(
      Events.FileSystemRemoved,
      (event) => this.fileSystemRemoved(event.data),
      this
    );
    ...
    const addButton = UI.UIUtils.createTextButton(
      i18nString(UIStrings.addFolder),
      this.addFileSystemClicked.bind(this),
  ...
  addItem(fileSystem) {
    ...
    const removeButton = UI.UIUtils.createTextButton(
      ...
      this.removeFileSystemClicked.bind(this, fileSystem),
