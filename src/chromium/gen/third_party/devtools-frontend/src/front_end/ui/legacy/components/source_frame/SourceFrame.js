...
export class SelfXssWarningDialog {
  static async show() {
    ...
    const shadowRoot = UI.UIUtils.createShadowRootWithCoreStyles(
      ...
      { cssFile: selfXssDialogStyles, delegatesFocus: void 0 }
    );
    ...
    const result = await new Promise((resolve) => {
      ...
      content.createChild("div", "message").textContent = i18nString(UIStrings.doNotPaste, { PH1: i18nString(UIStrings.allowPasting) });
