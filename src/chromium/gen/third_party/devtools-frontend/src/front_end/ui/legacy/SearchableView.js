...
export class SearchableView extends VBox {
  ...
  toggleCaseSensitiveSearch() {
    if (this.caseSensitiveButton) {
      this.caseSensitiveButton.title = this.caseSensitiveButton.toggled ? i18nString(UIStrings.disableCaseSensitive) : i18nString(UIStrings.enableCaseSensitive);
    }
    this.saveSetting();
  ...
  loadSetting() {
    ...
    if (this.searchProvider.supportsCaseSensitiveSearch() && this.caseSensitiveButton) {
      ...
      const label = settingValue.caseSensitive ? i18nString(UIStrings.disableCaseSensitive) : i18nString(UIStrings.enableCaseSensitive);
    ...
    if (this.searchProvider.supportsRegexSearch() && this.regexButton) {
      ...
      const label = settingValue.regular ? i18nString(UIStrings.disableRegularExpression) : i18nString(UIStrings.enableRegularExpression);
