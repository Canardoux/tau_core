...
export class TreeOutlineInShadow extends TreeOutline {
  ...
  disclosureElement;
  renderSelection;
  constructor(variant = "Other" /* OTHER */) {
    super();
    this.contentElement.classList.add("tree-outline");
    this.element = document.createElement("div");
    this.shadowRoot = createShadowRootWithCoreStyles(this.element, { cssFile: treeoutlineStyles, delegatesFocus: void 0 });
...
export class TreeElement {
  ...
  set hidden(x) {
    ...
    if (x && this.treeOutline && this.treeOutline.selectedTreeElement && this.treeOutline.selectedTreeElement.hasAncestorOrSelf(this)) {
