...
export class ListWidget extends VBox {
  ...
  createControls(item, element) {
    ...
    const editButton = new ToolbarButton(i18nString(UIStrings.editString), "edit", void 0, "edit-item");
    editButton.addEventListener(ToolbarButton.Events.CLICK, onEditClicked.bind(this));
    toolbar.appendToolbarItem(editButton);
    const removeButton = new ToolbarButton(i18nString(UIStrings.removeString), "bin", void 0, "remove-item");
...
export class Editor {
  ...
  constructor() {
    ...
    this.controls = [];
    this.controlByName = /* @__PURE__ */ new Map();
    this.validators = [];
    this.commit = null;
    this.cancel = null;
    this.item = null;
