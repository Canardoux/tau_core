...
export function setActiveDescendant(element, activedescendant) {
  ...
  if (activedescendant.isConnected && element.isConnected) {
    console.assert(
      Platform.DOMUtilities.getEnclosingShadowRootForNode(activedescendant) === Platform.DOMUtilities.getEnclosingShadowRootForNode(element),
...
const alertElements = /* @__PURE__ */ new WeakMap();
...
export function alert(message) {
  ...
  const element = alertElementInstance(dialog && dialog.isShowing() ? dialog.contentElement : void 0);
