...
export class SuggestBox {
  ...
  constructor(suggestBoxDelegate, maxItemsHeight) {
    ...
    const shadowRoot = createShadowRootWithCoreStyles(
      ...
      { cssFile: suggestBoxStyles, delegatesFocus: void 0 }
    );
  ...
  applySuggestion(isIntermediateSuggestion) {
    if (this.onlyCompletion) {
      isIntermediateSuggestion ? ARIAUtils.alert(i18nString(
    ...
    if (suggestion && suggestion.text) {
      isIntermediateSuggestion ? ARIAUtils.alert(i18nString(UIStrings.sSuggestionSOfS, {
