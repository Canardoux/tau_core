...
export class GlassPane {
  ...
  constructor(jslog) {
    ...
    this.positionY = null;
    this.anchorBox = null;
    this.anchorBehavior = "PreferTop" /* PREFER_TOP */;
    this.sizeBehavior = "SetExactSize" /* SET_EXACT_SIZE */;
    this.marginBehavior = "DefaultMargin" /* DEFAULT_MARGIN */;
  }
  setJsLog(jslog) {
    this.contentElement.setAttribute("jslog", jslog);
  }
  ...
  positionContent() {
    ...
    const gutterSize = showArrow ? 8 : this.marginBehavior === "NoMargin" /* NO_MARGIN */ ? 0 : 3;
