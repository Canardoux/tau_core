...
export function installDragHandle(element, elementDragStart2, elementDrag, elementDragEnd, cursor, hoverCursor, startDelay) {
  function onMouseDown(event) {
    const dragHandler = new DragHandler();
    const dragStart = () => dragHandler.elementDragStart(element, elementDragStart2, elementDrag, elementDragEnd, cursor, event);
    if (startDelay) {
...
class DragHandler {
  ...
  elementDragStart(targetElement, elementDragStart2, elementDrag, elementDragEnd, cursor, ev) {
    const event = ev;
    ...
    DragHandler.rootForMouseOut && DragHandler.rootForMouseOut.addEventListener("pointerout", this.mouseOutWhileDragging, { capture: true });
...
export class CheckboxLabel extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadowRootInternal = createShadowRootWithCoreStyles(this, { cssFile: checkboxTextLabelStyles, delegatesFocus: void 0 });
...
export class DevToolsRadioButton extends HTMLSpanElement {
  ...
  constructor() {
    ...
    const root = createShadowRootWithCoreStyles(this, { cssFile: radioButtonStyles, delegatesFocus: void 0 });
    root.createChild("slot");
...
export class DevToolsSlider extends HTMLSpanElement {
  ...
  constructor() {
    super();
    const root = createShadowRootWithCoreStyles(this, { cssFile: sliderStyles, delegatesFocus: void 0 });
...
export class DevToolsSmallBubble extends HTMLSpanElement {
  ...
  constructor() {
    super();
    const root = createShadowRootWithCoreStyles(this, { cssFile: smallBubbleStyles, delegatesFocus: void 0 });
...
export class DevToolsCloseButton extends HTMLDivElement {
  ...
  constructor() {
    super();
    const root = createShadowRootWithCoreStyles(this, { delegatesFocus: void 0 });
...
export function bindInput(input, apply, validate, numeric, modifierMultiplier) {
  ...
  function onKeyDown(event) {
    if (event.key === "Enter") {
      const { valid: valid2 } = validate(input.value);
      if (valid2) {
        apply(input.value);
      }
      event.preventDefault();
...
export class MessageDialog {
  static async show(message, where, jslogContext) {
    ...
    const shadowRoot = createShadowRootWithCoreStyles(
      ...
      { cssFile: confirmDialogStyles, delegatesFocus: void 0 }
    );
...
export function createInlineButton(toolbarButton) {
  ...
  const shadowRoot = createShadowRootWithCoreStyles(element, { cssFile: inlineButtonStyles, delegatesFocus: void 0 });
...
function focusChanged(event) {
  ...
  const element = document2 ? Platform.DOMUtilities.deepActiveElement(document2) : null;
