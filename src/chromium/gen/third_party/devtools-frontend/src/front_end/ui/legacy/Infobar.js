...
export class Infobar {
  ...
  parentView;
  constructor(type, text, actions, disableSetting, isCloseable = true, jslogContext) {
    ...
    this.shadowRoot = createShadowRootWithCoreStyles(this.element, { cssFile: infobarStyles, delegatesFocus: void 0 });
  ...
  static create(type, text, actions, disableSetting, jslogContext) {
    ...
    return new Infobar(type, text, actions, disableSetting, void 0, jslogContext);
  }
  dispose() {
    this.element.remove();
    this.onResize();
