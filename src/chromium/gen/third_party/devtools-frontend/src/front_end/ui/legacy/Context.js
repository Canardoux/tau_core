...
export class Context {
  ...
  addFlavorChangeListener(flavorType, listener, thisObject) {
    ...
    dispatcher.addEventListener("FlavorChanged" /* FLAVOR_CHANGED */, listener, thisObject);
  }
  removeFlavorChangeListener(flavorType, listener, thisObject) {
    ...
    dispatcher.removeEventListener("FlavorChanged" /* FLAVOR_CHANGED */, listener, thisObject);
