...
PROTOBUF_CONSTEXPR UrlInfo::UrlInfo(
  ...
  , /*decltype(_impl_.previous_url_count_)*/0} {}
...
PROTOBUF_CONSTEXPR NavigationMetadata::NavigationMetadata(
    ...
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.same_origin_status_)*/0
  , /*decltype(_impl_.is_renderer_initiated_)*/false
  , /*decltype(_impl_.is_error_page_)*/false} {}
...
PROTOBUF_CONSTEXPR Source::Source(
  ...
  , /*decltype(_impl_.resolved_urls_)*/{}
  , /*decltype(_impl_.deprecated_url_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.deprecated_initial_url_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.navigation_metadata_)*/nullptr
  , /*decltype(_impl_.id_)*/int64_t{0}
  , /*decltype(_impl_.navigation_time_msec_)*/int64_t{0}
  , /*decltype(_impl_.tab_id_)*/int64_t{0}
  , /*decltype(_impl_.previous_source_id_)*/int64_t{0}
  , /*decltype(_impl_.opener_source_id_)*/int64_t{0}
  , /*decltype(_impl_.previous_same_document_source_id_)*/int64_t{0}
  , /*decltype(_impl_.is_same_document_navigation_)*/false
  , /*decltype(_impl_.type_)*/0
  , /*decltype(_impl_.android_activity_type_)*/0} {}
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry SourceType_entries[] = {
  ...
  { {SourceType_names + 85, 15}, 13 },
  { {SourceType_names + 100, 9}, 8 },
  { {SourceType_names + 109, 14}, 5 },
  { {SourceType_names + 123, 11}, 9 },
  { {SourceType_names + 134, 9}, 4 },
  { {SourceType_names + 143, 15}, 10 },
  { {SourceType_names + 158, 9}, 7 },
};
...
static const int SourceType_entries_by_number[] = {
  ...
  8, // 8 -> NO_URL_ID
  10, // 9 -> REDIRECT_ID
  12, // 10 -> WEB_IDENTITY_ID
  1, // 11 -> CHROMEOS_WEBSITE_ID
  4, // 12 -> EXTENSION_ID
  7, // 13 -> NOTIFICATION_ID
};
...
bool SourceType_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      SourceType_entries, 14, name, &int_value);
  if (success) {
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> AndroidActivityType_strings[7] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry AndroidActivityType_entries[] = {
  ...
  { {AndroidActivityType_names + 18, 13}, 5 },
  { {AndroidActivityType_names + 31, 6}, 0 },
  { {AndroidActivityType_names + 37, 20}, 2 },
  { {AndroidActivityType_names + 57, 7}, 4 },
  { {AndroidActivityType_names + 64, 7}, 3 },
};

static const int AndroidActivityType_entries_by_number[] = {
  3, // 0 -> TABBED
  1, // 1 -> CUSTOM_TAB
  4, // 2 -> TRUSTED_WEB_ACTIVITY
  6, // 3 -> WEB_APP
  5, // 4 -> WEB_APK
  2, // 5 -> PRE_FIRST_TAB
  0, // 6 -> AUTH_TAB
...
bool AndroidActivityType_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      AndroidActivityType_entries, 7, name, &int_value);
  if (success) {
...
UrlInfo::UrlInfo(const UrlInfo& from)
  ...
  UrlInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.url_){}
    , decltype(_impl_.previous_url_count_){}};
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          _impl_.previous_url_count_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void UrlInfo::InternalSwap(UrlInfo* other) {
  ...
  swap(_impl_.previous_url_count_, other->_impl_.previous_url_count_);
}
...
NavigationMetadata::NavigationMetadata(const NavigationMetadata& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  NavigationMetadata* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.same_origin_status_){}
    , decltype(_impl_.is_renderer_initiated_){}
    , decltype(_impl_.is_error_page_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.same_origin_status_, &from._impl_.same_origin_status_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.is_error_page_) -
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          _impl_.is_renderer_initiated_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          _impl_.is_error_page_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void NavigationMetadata::MergeFrom(const NavigationMetadata& from) {
  NavigationMetadata* const _this = this;
...
Source::_Internal::navigation_metadata(const Source* msg) {
  return *msg->_impl_.navigation_metadata_;
}
...
Source::Source(const Source& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.resolved_urls_){from._impl_.resolved_urls_}
    , decltype(_impl_.deprecated_url_){}
    , decltype(_impl_.deprecated_initial_url_){}
    , decltype(_impl_.navigation_metadata_){nullptr}
    , decltype(_impl_.id_){}
    , decltype(_impl_.navigation_time_msec_){}
    , decltype(_impl_.tab_id_){}
    , decltype(_impl_.previous_source_id_){}
    , decltype(_impl_.opener_source_id_){}
    , decltype(_impl_.previous_same_document_source_id_){}
    , decltype(_impl_.is_same_document_navigation_){}
    , decltype(_impl_.type_){}
    , decltype(_impl_.android_activity_type_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  _impl_.deprecated_url_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.deprecated_url_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_deprecated_url()) {
    _this->_impl_.deprecated_url_.Set(from._internal_deprecated_url(), 
      _this->GetArenaForAllocation());
  }
  _impl_.deprecated_initial_url_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.deprecated_initial_url_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_deprecated_initial_url()) {
    _this->_impl_.deprecated_initial_url_.Set(from._internal_deprecated_initial_url(), 
      _this->GetArenaForAllocation());
  }
  if (from._internal_has_navigation_metadata()) {
    _this->_impl_.navigation_metadata_ = new ::ukm::NavigationMetadata(*from._impl_.navigation_metadata_);
  }
  ::memcpy(&_impl_.id_, &from._impl_.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.android_activity_type_) -
    reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.android_activity_type_));
...
inline void Source::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.resolved_urls_){arena}
    , decltype(_impl_.deprecated_url_){}
    , decltype(_impl_.deprecated_initial_url_){}
    , decltype(_impl_.navigation_metadata_){nullptr}
    , decltype(_impl_.id_){int64_t{0}}
...
inline void Source::SharedDtor() {
  ...
  _impl_.resolved_urls_.~RepeatedPtrField();
  _impl_.deprecated_url_.Destroy();
  _impl_.deprecated_initial_url_.Destroy();
  if (this != internal_default_instance()) delete _impl_.navigation_metadata_;
}
...
// @@protoc_insertion_point(message_clear_start:ukm.Source)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      GOOGLE_DCHECK(_impl_.navigation_metadata_ != nullptr);
      _impl_.navigation_metadata_->Clear();
    }
  }
  if (cached_has_bits & 0x000000f8u) {
    ::memset(&_impl_.id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.opener_source_id_) -
        reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.opener_source_id_));
  }
  if (cached_has_bits & 0x00000f00u) {
    ::memset(&_impl_.previous_same_document_source_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.android_activity_type_) -
        reinterpret_cast<char*>(&_impl_.previous_same_document_source_id_)) + sizeof(_impl_.android_activity_type_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          _impl_.navigation_time_msec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 88)) {
          ...
          _impl_.previous_source_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          ...
          _impl_.opener_source_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 104)) {
          ...
          _impl_.is_same_document_navigation_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 112)) {
          ...
          _impl_.previous_same_document_source_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:ukm.Source)
  ...
  for (const auto& msg : this->_impl_.resolved_urls_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void Source::MergeFrom(const Source& from) {
  ...
  _this->_impl_.resolved_urls_.MergeFrom(from._impl_.resolved_urls_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_navigation_metadata()->::ukm::NavigationMetadata::MergeFrom(
          from._internal_navigation_metadata());
    }
    if (cached_has_bits & 0x00000008u) {
...
void Source::InternalSwap(Source* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.deprecated_url_, lhs_arena,
      &other->_impl_.deprecated_url_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.deprecated_initial_url_, lhs_arena,
      &other->_impl_.deprecated_initial_url_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
