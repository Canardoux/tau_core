...
class UserDemographicsProto::_Internal {
 public:
  using HasBits = decltype(std::declval<UserDemographicsProto>()._impl_._has_bits_);
...
UserDemographicsProto::UserDemographicsProto(const UserDemographicsProto& from)
  ...
  UserDemographicsProto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  ::memcpy(&_impl_.birth_year_, &from._impl_.birth_year_,
    ...
    reinterpret_cast<char*>(&_impl_.birth_year_)) + sizeof(_impl_.gender_));
...
void UserDemographicsProto::MergeFrom(const UserDemographicsProto& from) {
  UserDemographicsProto* const _this = this;
...
void UserDemographicsProto::InternalSwap(UserDemographicsProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(UserDemographicsProto, _impl_.gender_)
      + sizeof(UserDemographicsProto::_impl_.gender_)
      - PROTOBUF_FIELD_OFFSET(UserDemographicsProto, _impl_.birth_year_)>(
