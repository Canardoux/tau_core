...
PROTOBUF_CONSTEXPR PrinterEventProto::PrinterEventProto(
  ...
  , /*decltype(_impl_.usb_printer_manufacturer_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.usb_printer_model_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.ipp_make_and_model_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.ppd_identifier_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.usb_vendor_id_)*/0
  , /*decltype(_impl_.usb_model_id_)*/0
  , /*decltype(_impl_.user_ppd_)*/false
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PrinterEventProtoDefaultTypeInternal _PrinterEventProto_default_instance_;
}  // namespace metrics
namespace metrics {
...
class PrinterEventProto::_Internal {
 public:
  using HasBits = decltype(std::declval<PrinterEventProto>()._impl_._has_bits_);
...
PrinterEventProto::PrinterEventProto(const PrinterEventProto& from)
  ...
  PrinterEventProto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.usb_printer_manufacturer_){}
    , decltype(_impl_.usb_printer_model_){}
    , decltype(_impl_.ipp_make_and_model_){}
    , decltype(_impl_.ppd_identifier_){}
    , decltype(_impl_.usb_vendor_id_){}
    , decltype(_impl_.usb_model_id_){}
    , decltype(_impl_.user_ppd_){}
    , decltype(_impl_.event_type_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  _impl_.usb_printer_manufacturer_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.usb_printer_manufacturer_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_usb_printer_manufacturer()) {
    _this->_impl_.usb_printer_manufacturer_.Set(from._internal_usb_printer_manufacturer(), 
      _this->GetArenaForAllocation());
  }
  _impl_.usb_printer_model_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.usb_printer_model_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_usb_printer_model()) {
    _this->_impl_.usb_printer_model_.Set(from._internal_usb_printer_model(), 
      _this->GetArenaForAllocation());
  }
  _impl_.ipp_make_and_model_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.ipp_make_and_model_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_ipp_make_and_model()) {
    _this->_impl_.ipp_make_and_model_.Set(from._internal_ipp_make_and_model(), 
      _this->GetArenaForAllocation());
  }
  _impl_.ppd_identifier_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.ppd_identifier_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_ppd_identifier()) {
    _this->_impl_.ppd_identifier_.Set(from._internal_ppd_identifier(), 
      _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.usb_vendor_id_, &from._impl_.usb_vendor_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.event_type_) -
    reinterpret_cast<char*>(&_impl_.usb_vendor_id_)) + sizeof(_impl_.event_type_));
...
inline void PrinterEventProto::SharedDtor() {
  ...
  _impl_.usb_printer_manufacturer_.Destroy();
  _impl_.usb_printer_model_.Destroy();
  _impl_.ipp_make_and_model_.Destroy();
  _impl_.ppd_identifier_.Destroy();
}
...
// @@protoc_insertion_point(message_clear_start:metrics.PrinterEventProto)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      _impl_.usb_printer_manufacturer_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000002u) {
      _impl_.usb_printer_model_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000004u) {
      _impl_.ipp_make_and_model_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000008u) {
      _impl_.ppd_identifier_.ClearNonDefaultToEmpty();
    }
  }
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          _impl_.usb_model_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          _impl_.user_ppd_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void PrinterEventProto::MergeFrom(const PrinterEventProto& from) {
  PrinterEventProto* const _this = this;
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_usb_printer_manufacturer(from._internal_usb_printer_manufacturer());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_usb_printer_model(from._internal_usb_printer_model());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_ipp_make_and_model(from._internal_ipp_make_and_model());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_set_ppd_identifier(from._internal_ppd_identifier());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.usb_vendor_id_ = from._impl_.usb_vendor_id_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.usb_model_id_ = from._impl_.usb_model_id_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.user_ppd_ = from._impl_.user_ppd_;
    }
    if (cached_has_bits & 0x00000080u) {
...
void PrinterEventProto::InternalSwap(PrinterEventProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.usb_printer_manufacturer_, lhs_arena,
      &other->_impl_.usb_printer_manufacturer_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.usb_printer_model_, lhs_arena,
      &other->_impl_.usb_printer_model_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.ipp_make_and_model_, lhs_arena,
      &other->_impl_.ipp_make_and_model_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.ppd_identifier_, lhs_arena,
      &other->_impl_.ppd_identifier_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PrinterEventProto, _impl_.event_type_)
      + sizeof(PrinterEventProto::_impl_.event_type_)
      - PROTOBUF_FIELD_OFFSET(PrinterEventProto, _impl_.usb_vendor_id_)>(
