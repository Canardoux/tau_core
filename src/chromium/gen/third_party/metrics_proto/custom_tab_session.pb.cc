...
PROTOBUF_CONSTEXPR CustomTabSessionProto::CustomTabSessionProto(
  ...
  , /*decltype(_impl_.session_duration_sec_)*/0
  , /*decltype(_impl_.did_user_interact_)*/false
  , /*decltype(_impl_.was_user_closed_)*/false
...
class CustomTabSessionProto::_Internal {
 public:
  using HasBits = decltype(std::declval<CustomTabSessionProto>()._impl_._has_bits_);
...
CustomTabSessionProto::CustomTabSessionProto(const CustomTabSessionProto& from)
  ...
  CustomTabSessionProto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.did_user_interact_){}
    , decltype(_impl_.was_user_closed_){}
  ...
  ::memcpy(&_impl_.time_sec_, &from._impl_.time_sec_,
    ...
    reinterpret_cast<char*>(&_impl_.time_sec_)) + sizeof(_impl_.is_partial_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          _impl_.session_duration_sec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          _impl_.did_user_interact_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          _impl_.was_user_closed_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void CustomTabSessionProto::MergeFrom(const CustomTabSessionProto& from) {
  CustomTabSessionProto* const _this = this;
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.did_user_interact_ = from._impl_.did_user_interact_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.was_user_closed_ = from._impl_.was_user_closed_;
    }
    if (cached_has_bits & 0x00000020u) {
...
void CustomTabSessionProto::InternalSwap(CustomTabSessionProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CustomTabSessionProto, _impl_.is_partial_)
      + sizeof(CustomTabSessionProto::_impl_.is_partial_)
      - PROTOBUF_FIELD_OFFSET(CustomTabSessionProto, _impl_.time_sec_)>(
