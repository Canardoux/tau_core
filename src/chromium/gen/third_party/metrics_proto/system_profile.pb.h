...
struct SystemProfileProto_TpmIdentifierDefaultTypeInternal;
extern SystemProfileProto_TpmIdentifierDefaultTypeInternal _SystemProfileProto_TpmIdentifier_default_instance_;
}  // namespace metrics
PROTOBUF_NAMESPACE_OPEN
...
template<> ::metrics::SystemProfileProto_TpmIdentifier* Arena::CreateMaybeMessage<::metrics::SystemProfileProto_TpmIdentifier>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace metrics {
...
enum SystemProfileProto_ComponentId : int {
  ...
  SystemProfileProto_ComponentId_GROWTH_CAMPAIGNS = 64,
  SystemProfileProto_ComponentId_MASKED_DOMAIN_LIST = 65
};
...
constexpr SystemProfileProto_ComponentId SystemProfileProto_ComponentId_ComponentId_MAX = SystemProfileProto_ComponentId_MASKED_DOMAIN_LIST;
...
class SystemProfileProto_Hardware_CPU final :
 ...
 public:
  ...
  enum : int {
    ...
    kNumEfficientCoresFieldNumber = 5,
  };
  ...
  bool has_num_efficient_cores() const;
  private:
  bool _internal_has_num_efficient_cores() const;
  public:
  void clear_num_efficient_cores();
  uint32_t num_efficient_cores() const;
  void set_num_efficient_cores(uint32_t value);
  private:
  uint32_t _internal_num_efficient_cores() const;
  void _internal_set_num_efficient_cores(uint32_t value);
  public:
...
class SystemProfileProto_TpmIdentifier final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:metrics.SystemProfileProto.TpmIdentifier) */ {
 public:
  inline SystemProfileProto_TpmIdentifier() : SystemProfileProto_TpmIdentifier(nullptr) {}
  ~SystemProfileProto_TpmIdentifier() override;
  explicit PROTOBUF_CONSTEXPR SystemProfileProto_TpmIdentifier(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SystemProfileProto_TpmIdentifier(const SystemProfileProto_TpmIdentifier& from);
  SystemProfileProto_TpmIdentifier(SystemProfileProto_TpmIdentifier&& from) noexcept
    : SystemProfileProto_TpmIdentifier() {
    *this = ::std::move(from);
  }

  inline SystemProfileProto_TpmIdentifier& operator=(const SystemProfileProto_TpmIdentifier& from) {
    CopyFrom(from);
    return *this;
  }
  inline SystemProfileProto_TpmIdentifier& operator=(SystemProfileProto_TpmIdentifier&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SystemProfileProto_TpmIdentifier& default_instance() {
    return *internal_default_instance();
  }
  static inline const SystemProfileProto_TpmIdentifier* internal_default_instance() {
    return reinterpret_cast<const SystemProfileProto_TpmIdentifier*>(
               &_SystemProfileProto_TpmIdentifier_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    23;

  friend void swap(SystemProfileProto_TpmIdentifier& a, SystemProfileProto_TpmIdentifier& b) {
    a.Swap(&b);
  }
  PROTOBUF_NOINLINE void Swap(SystemProfileProto_TpmIdentifier* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SystemProfileProto_TpmIdentifier* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SystemProfileProto_TpmIdentifier* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SystemProfileProto_TpmIdentifier>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
  void CopyFrom(const SystemProfileProto_TpmIdentifier& from);
  void MergeFrom(const SystemProfileProto_TpmIdentifier& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(SystemProfileProto_TpmIdentifier* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "metrics.SystemProfileProto.TpmIdentifier";
  }
  protected:
  explicit SystemProfileProto_TpmIdentifier(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kManufacturerVersionFieldNumber = 2,
    kManufacturerVersionInfoFieldNumber = 4,
    kTpmSpecificVersionFieldNumber = 6,
    kManufacturerIdFieldNumber = 1,
    kManufacturerVersionHashFieldNumber = 3,
    kManufacturerVersionInfoHashFieldNumber = 5,
    kTpmSpecificVersionHashFieldNumber = 7,
  };
  // optional string manufacturer_version = 2;
  bool has_manufacturer_version() const;
  private:
  bool _internal_has_manufacturer_version() const;
  public:
  void clear_manufacturer_version();
  const std::string& manufacturer_version() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_manufacturer_version(ArgT0&& arg0, ArgT... args);
  std::string* mutable_manufacturer_version();
  PROTOBUF_NODISCARD std::string* release_manufacturer_version();
  void set_allocated_manufacturer_version(std::string* manufacturer_version);
  private:
  const std::string& _internal_manufacturer_version() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_manufacturer_version(const std::string& value);
  std::string* _internal_mutable_manufacturer_version();
  public:

  // optional string manufacturer_version_info = 4;
  bool has_manufacturer_version_info() const;
  private:
  bool _internal_has_manufacturer_version_info() const;
  public:
  void clear_manufacturer_version_info();
  const std::string& manufacturer_version_info() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_manufacturer_version_info(ArgT0&& arg0, ArgT... args);
  std::string* mutable_manufacturer_version_info();
  PROTOBUF_NODISCARD std::string* release_manufacturer_version_info();
  void set_allocated_manufacturer_version_info(std::string* manufacturer_version_info);
  private:
  const std::string& _internal_manufacturer_version_info() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_manufacturer_version_info(const std::string& value);
  std::string* _internal_mutable_manufacturer_version_info();
  public:

  // optional string tpm_specific_version = 6;
  bool has_tpm_specific_version() const;
  private:
  bool _internal_has_tpm_specific_version() const;
  public:
  void clear_tpm_specific_version();
  const std::string& tpm_specific_version() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_tpm_specific_version(ArgT0&& arg0, ArgT... args);
  std::string* mutable_tpm_specific_version();
  PROTOBUF_NODISCARD std::string* release_tpm_specific_version();
  void set_allocated_tpm_specific_version(std::string* tpm_specific_version);
  private:
  const std::string& _internal_tpm_specific_version() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_tpm_specific_version(const std::string& value);
  std::string* _internal_mutable_tpm_specific_version();
  public:
  ...
  uint32_t manufacturer_id() const;
  void set_manufacturer_id(uint32_t value);
  private:
  uint32_t _internal_manufacturer_id() const;
  void _internal_set_manufacturer_id(uint32_t value);
  public:

  // optional fixed32 manufacturer_version_hash = 3;
  bool has_manufacturer_version_hash() const;
  private:
  bool _internal_has_manufacturer_version_hash() const;
  public:
  void clear_manufacturer_version_hash();
  uint32_t manufacturer_version_hash() const;
  void set_manufacturer_version_hash(uint32_t value);
  private:
  uint32_t _internal_manufacturer_version_hash() const;
  void _internal_set_manufacturer_version_hash(uint32_t value);
  public:

  // optional fixed32 manufacturer_version_info_hash = 5;
  bool has_manufacturer_version_info_hash() const;
  private:
  bool _internal_has_manufacturer_version_info_hash() const;
  public:
  void clear_manufacturer_version_info_hash();
  uint32_t manufacturer_version_info_hash() const;
  void set_manufacturer_version_info_hash(uint32_t value);
  private:
  uint32_t _internal_manufacturer_version_info_hash() const;
  void _internal_set_manufacturer_version_info_hash(uint32_t value);
  public:

  // optional fixed32 tpm_specific_version_hash = 7;
  bool has_tpm_specific_version_hash() const;
  private:
  bool _internal_has_tpm_specific_version_hash() const;
  public:
  void clear_tpm_specific_version_hash();
  uint32_t tpm_specific_version_hash() const;
  void set_tpm_specific_version_hash(uint32_t value);
  private:
  uint32_t _internal_tpm_specific_version_hash() const;
  void _internal_set_tpm_specific_version_hash(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:metrics.SystemProfileProto.TpmIdentifier)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr manufacturer_version_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr manufacturer_version_info_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr tpm_specific_version_;
    uint32_t manufacturer_id_;
    uint32_t manufacturer_version_hash_;
    uint32_t manufacturer_version_info_hash_;
    uint32_t tpm_specific_version_hash_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_system_5fprofile_2eproto;
};
...
class SystemProfileProto final :
 ...
 public:
  ...
  typedef SystemProfileProto_TpmIdentifier TpmIdentifier;
  ...
  static constexpr ComponentId GROWTH_CAMPAIGNS =
    SystemProfileProto_ComponentId_GROWTH_CAMPAIGNS;
  static constexpr ComponentId MASKED_DOMAIN_LIST =
  ...
  // optional .metrics.SystemProfileProto.TpmIdentifier tpm_identifier = 47;
  bool has_tpm_identifier() const;
  private:
  bool _internal_has_tpm_identifier() const;
  public:
  void clear_tpm_identifier();
  const ::metrics::SystemProfileProto_TpmIdentifier& tpm_identifier() const;
  PROTOBUF_NODISCARD ::metrics::SystemProfileProto_TpmIdentifier* release_tpm_identifier();
  ::metrics::SystemProfileProto_TpmIdentifier* mutable_tpm_identifier();
  void set_allocated_tpm_identifier(::metrics::SystemProfileProto_TpmIdentifier* tpm_identifier);
  private:
  const ::metrics::SystemProfileProto_TpmIdentifier& _internal_tpm_identifier() const;
  ::metrics::SystemProfileProto_TpmIdentifier* _internal_mutable_tpm_identifier();
  public:
  void unsafe_arena_set_allocated_tpm_identifier(
      ::metrics::SystemProfileProto_TpmIdentifier* tpm_identifier);
  ::metrics::SystemProfileProto_TpmIdentifier* unsafe_arena_release_tpm_identifier();
  ...
  bool has_session_hash() const;
  private:
  bool _internal_has_session_hash() const;
  public:
  void clear_session_hash();
  uint64_t session_hash() const;
  void set_session_hash(uint64_t value);
  private:
  uint64_t _internal_session_hash() const;
  void _internal_set_session_hash(uint64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::metrics::SystemProfileProto_TpmIdentifier* tpm_identifier_;
...
inline void SystemProfileProto_ClonedInstallInfo::_internal_set_cloned_from_client_id(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.cloned_from_client_id_ = value;
}
...
inline void SystemProfileProto_OS::clear_build_fingerprint() {
  _impl_.build_fingerprint_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
...
void SystemProfileProto_OS::set_build_fingerprint(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.build_fingerprint_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_OS::release_build_fingerprint() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.build_fingerprint_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.build_fingerprint_.IsDefault()) {
    _impl_.build_fingerprint_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_OS::set_allocated_build_fingerprint(std::string* build_fingerprint) {
  ...
  _impl_.build_fingerprint_.SetAllocated(build_fingerprint, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.build_fingerprint_.IsDefault()) {
    _impl_.build_fingerprint_.Set("", GetArenaForAllocation());
  }
...
void SystemProfileProto_OS::set_build_number(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.build_number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SystemProfileProto_OS::_internal_set_build_number(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.build_number_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto_OS::_internal_mutable_build_number() {
  _impl_._has_bits_[0] |= 0x00000008u;
  return _impl_.build_number_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto_OS::release_build_number() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.build_number_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.build_number_.IsDefault()) {
    _impl_.build_number_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_OS::set_allocated_build_number(std::string* build_number) {
  ...
  _impl_.build_number_.SetAllocated(build_number, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.build_number_.IsDefault()) {
    _impl_.build_number_.Set("", GetArenaForAllocation());
  }
...
inline std::string* SystemProfileProto_OS::release_kernel_version() {
  ...
  _impl_._has_bits_[0] &= ~0x00000010u;
  auto* p = _impl_.kernel_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline bool SystemProfileProto_OS::_internal_has_arc() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.arc_ != nullptr);
  return value;
}
...
inline ::metrics::SystemProfileProto_OS_Arc* SystemProfileProto_OS::release_arc() {
  _impl_._has_bits_[0] &= ~0x00000020u;
  ::metrics::SystemProfileProto_OS_Arc* temp = _impl_.arc_;
  _impl_.arc_ = nullptr;
...
inline void SystemProfileProto_OS::clear_dark_mode_state() {
  _impl_.dark_mode_state_ = 0;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline ::metrics::SystemProfileProto_OS_DarkModeState SystemProfileProto_OS::_internal_dark_mode_state() const {
  return static_cast< ::metrics::SystemProfileProto_OS_DarkModeState >(_impl_.dark_mode_state_);
}
...
inline void SystemProfileProto_OS::clear_xdg_session_type() {
  _impl_.xdg_session_type_ = 0;
  _impl_._has_bits_[0] &= ~0x00000080u;
}
inline ::metrics::SystemProfileProto_OS_XdgSessionType SystemProfileProto_OS::_internal_xdg_session_type() const {
  return static_cast< ::metrics::SystemProfileProto_OS_XdgSessionType >(_impl_.xdg_session_type_);
}
...
inline void SystemProfileProto_OS::_internal_set_xdg_session_type(::metrics::SystemProfileProto_OS_XdgSessionType value) {
  ...
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.xdg_session_type_ = value;
}
...
inline ::metrics::SystemProfileProto_OS_XdgCurrentDesktop SystemProfileProto_OS::_internal_xdg_current_desktop() const {
  return static_cast< ::metrics::SystemProfileProto_OS_XdgCurrentDesktop >(_impl_.xdg_current_desktop_);
}
...
inline void SystemProfileProto_OS::_internal_set_xdg_current_desktop(::metrics::SystemProfileProto_OS_XdgCurrentDesktop value) {
  ...
  _impl_._has_bits_[0] |= 0x00000100u;
  _impl_.xdg_current_desktop_ = value;
}
...
// optional uint32 num_efficient_cores = 5;
inline bool SystemProfileProto_Hardware_CPU::_internal_has_num_efficient_cores() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool SystemProfileProto_Hardware_CPU::has_num_efficient_cores() const {
  return _internal_has_num_efficient_cores();
}
inline void SystemProfileProto_Hardware_CPU::clear_num_efficient_cores() {
  _impl_.num_efficient_cores_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline uint32_t SystemProfileProto_Hardware_CPU::_internal_num_efficient_cores() const {
  return _impl_.num_efficient_cores_;
}
inline uint32_t SystemProfileProto_Hardware_CPU::num_efficient_cores() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.Hardware.CPU.num_efficient_cores)
  return _internal_num_efficient_cores();
}
inline void SystemProfileProto_Hardware_CPU::_internal_set_num_efficient_cores(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.num_efficient_cores_ = value;
}
inline void SystemProfileProto_Hardware_CPU::set_num_efficient_cores(uint32_t value) {
  _internal_set_num_efficient_cores(value);
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.Hardware.CPU.num_efficient_cores)
}
...
inline void SystemProfileProto_Hardware_Motherboard::clear_bios_manufacturer() {
  _impl_.bios_manufacturer_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
...
void SystemProfileProto_Hardware_Motherboard::set_bios_manufacturer(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.bios_manufacturer_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_Hardware_Motherboard::release_bios_manufacturer() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.bios_manufacturer_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.bios_manufacturer_.IsDefault()) {
    _impl_.bios_manufacturer_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_Hardware_Motherboard::set_allocated_bios_manufacturer(std::string* bios_manufacturer) {
  ...
  _impl_.bios_manufacturer_.SetAllocated(bios_manufacturer, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.bios_manufacturer_.IsDefault()) {
    _impl_.bios_manufacturer_.Set("", GetArenaForAllocation());
  }
...
inline ::metrics::SystemProfileProto_Hardware_BiosType SystemProfileProto_Hardware_Motherboard::_internal_bios_type() const {
  return static_cast< ::metrics::SystemProfileProto_Hardware_BiosType >(_impl_.bios_type_);
}
...
inline void SystemProfileProto_Hardware_Graphics::clear_gl_vendor() {
  _impl_.gl_vendor_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
...
void SystemProfileProto_Hardware_Graphics::set_gl_vendor(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.gl_vendor_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_Hardware_Graphics::release_gl_vendor() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.gl_vendor_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.gl_vendor_.IsDefault()) {
...
inline void SystemProfileProto_Hardware_Graphics::set_allocated_gl_vendor(std::string* gl_vendor) {
  ...
  _impl_.gl_vendor_.SetAllocated(gl_vendor, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.gl_vendor_.IsDefault()) {
    _impl_.gl_vendor_.Set("", GetArenaForAllocation());
  }
...
void SystemProfileProto_Hardware_Graphics::set_gl_renderer(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.gl_renderer_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SystemProfileProto_Hardware_Graphics::_internal_set_gl_renderer(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.gl_renderer_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto_Hardware_Graphics::_internal_mutable_gl_renderer() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.gl_renderer_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto_Hardware_Graphics::release_gl_renderer() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.gl_renderer_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.gl_renderer_.IsDefault()) {
...
inline void SystemProfileProto_Hardware_Graphics::set_allocated_gl_renderer(std::string* gl_renderer) {
  ...
  _impl_.gl_renderer_.SetAllocated(gl_renderer, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.gl_renderer_.IsDefault()) {
    _impl_.gl_renderer_.Set("", GetArenaForAllocation());
  }
...
inline ::metrics::SystemProfileProto_Hardware_InternalStorageDevice_Type SystemProfileProto_Hardware_InternalStorageDevice::_internal_type() const {
  return static_cast< ::metrics::SystemProfileProto_Hardware_InternalStorageDevice_Type >(_impl_.type_);
}
...
inline ::metrics::SystemProfileProto_Hardware_InternalStorageDevice_Purpose SystemProfileProto_Hardware_InternalStorageDevice::_internal_purpose() const {
  return static_cast< ::metrics::SystemProfileProto_Hardware_InternalStorageDevice_Purpose >(_impl_.purpose_);
}
...
inline bool SystemProfileProto_Hardware_Drive::_internal_has_seek_penalty() const {
  return _impl_.has_seek_penalty_;
}
...
inline void SystemProfileProto_Hardware_Drive::_internal_set_has_seek_penalty(bool value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.has_seek_penalty_ = value;
}
...
inline void SystemProfileProto_Hardware::clear_app_cpu_architecture() {
  _impl_.app_cpu_architecture_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000008u;
}
...
void SystemProfileProto_Hardware::set_app_cpu_architecture(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.app_cpu_architecture_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_Hardware::release_app_cpu_architecture() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.app_cpu_architecture_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.app_cpu_architecture_.IsDefault()) {
    _impl_.app_cpu_architecture_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_Hardware::set_allocated_app_cpu_architecture(std::string* app_cpu_architecture) {
  ...
  _impl_.app_cpu_architecture_.SetAllocated(app_cpu_architecture, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.app_cpu_architecture_.IsDefault()) {
    _impl_.app_cpu_architecture_.Set("", GetArenaForAllocation());
  }
...
inline void SystemProfileProto_Hardware::clear_hardware_class() {
  _impl_.hardware_class_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
...
void SystemProfileProto_Hardware::set_hardware_class(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.hardware_class_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_Hardware::release_hardware_class() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.hardware_class_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.hardware_class_.IsDefault()) {
...
inline void SystemProfileProto_Hardware::set_allocated_hardware_class(std::string* hardware_class) {
  ...
  _impl_.hardware_class_.SetAllocated(hardware_class, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.hardware_class_.IsDefault()) {
    _impl_.hardware_class_.Set("", GetArenaForAllocation());
  }
...
inline void SystemProfileProto_Hardware::clear_cellular_device_variant() {
  _impl_.cellular_device_variant_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000010u;
}
...
void SystemProfileProto_Hardware::set_cellular_device_variant(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000010u;
 _impl_.cellular_device_variant_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_Hardware::release_cellular_device_variant() {
  ...
  _impl_._has_bits_[0] &= ~0x00000010u;
  auto* p = _impl_.cellular_device_variant_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.cellular_device_variant_.IsDefault()) {
    _impl_.cellular_device_variant_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_Hardware::set_allocated_cellular_device_variant(std::string* cellular_device_variant) {
  ...
  _impl_.cellular_device_variant_.SetAllocated(cellular_device_variant, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.cellular_device_variant_.IsDefault()) {
    _impl_.cellular_device_variant_.Set("", GetArenaForAllocation());
  }
...
inline void SystemProfileProto_Hardware::_internal_set_primary_screen_width(int32_t value) {
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.primary_screen_width_ = value;
}
...
inline void SystemProfileProto_Hardware::_internal_set_primary_screen_height(int32_t value) {
  _impl_._has_bits_[0] |= 0x00008000u;
  _impl_.primary_screen_height_ = value;
}
...
inline void SystemProfileProto_Hardware::_internal_set_primary_screen_scale_factor(float value) {
  _impl_._has_bits_[0] |= 0x00040000u;
  _impl_.primary_screen_scale_factor_ = value;
}
...
inline ::metrics::SystemProfileProto_Hardware_FormFactor SystemProfileProto_Hardware::_internal_form_factor() const {
  return static_cast< ::metrics::SystemProfileProto_Hardware_FormFactor >(_impl_.form_factor_);
}
...
inline const ::metrics::SystemProfileProto_Hardware_CPU& SystemProfileProto_Hardware::_internal_cpu() const {
  const ::metrics::SystemProfileProto_Hardware_CPU* p = _impl_.cpu_;
...
inline ::metrics::SystemProfileProto_Hardware_CPU* SystemProfileProto_Hardware::release_cpu() {
  _impl_._has_bits_[0] &= ~0x00000080u;
  ::metrics::SystemProfileProto_Hardware_CPU* temp = _impl_.cpu_;
  _impl_.cpu_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline bool SystemProfileProto_Hardware::_internal_has_motherboard() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.motherboard_ != nullptr);
  return value;
}
...
inline void SystemProfileProto_Hardware::clear_motherboard() {
  if (_impl_.motherboard_ != nullptr) _impl_.motherboard_->Clear();
...
inline const ::metrics::SystemProfileProto_Hardware_Motherboard& SystemProfileProto_Hardware::_internal_motherboard() const {
  const ::metrics::SystemProfileProto_Hardware_Motherboard* p = _impl_.motherboard_;
...
inline ::metrics::SystemProfileProto_Hardware_Motherboard* SystemProfileProto_Hardware::release_motherboard() {
  _impl_._has_bits_[0] &= ~0x00000400u;
  ::metrics::SystemProfileProto_Hardware_Motherboard* temp = _impl_.motherboard_;
...
inline const ::metrics::SystemProfileProto_Hardware_Graphics& SystemProfileProto_Hardware::_internal_gpu() const {
  const ::metrics::SystemProfileProto_Hardware_Graphics* p = _impl_.gpu_;
...
inline void SystemProfileProto_Hardware::unsafe_arena_set_allocated_gpu(
    ::metrics::SystemProfileProto_Hardware_Graphics* gpu) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.gpu_);
  }
  _impl_.gpu_ = gpu;
  if (gpu) {
    _impl_._has_bits_[0] |= 0x00000040u;
...
inline ::metrics::SystemProfileProto_Hardware_Graphics* SystemProfileProto_Hardware::release_gpu() {
  _impl_._has_bits_[0] &= ~0x00000040u;
  ::metrics::SystemProfileProto_Hardware_Graphics* temp = _impl_.gpu_;
  _impl_.gpu_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline void SystemProfileProto_Hardware::_internal_set_internal_display_supports_touch(bool value) {
  _impl_._has_bits_[0] |= 0x00080000u;
  _impl_.internal_display_supports_touch_ = value;
}
...
inline int SystemProfileProto_Hardware::_internal_internal_storage_devices_size() const {
  return _impl_.internal_storage_devices_.size();
}
...
inline ::metrics::SystemProfileProto_Hardware_InternalStorageDevice* SystemProfileProto_Hardware::mutable_internal_storage_devices(int index) {
  ...
  return _impl_.internal_storage_devices_.Mutable(index);
}
...
SystemProfileProto_Hardware::mutable_internal_storage_devices() {
  ...
  return &_impl_.internal_storage_devices_;
}
inline const ::metrics::SystemProfileProto_Hardware_InternalStorageDevice& SystemProfileProto_Hardware::_internal_internal_storage_devices(int index) const {
  return _impl_.internal_storage_devices_.Get(index);
}
...
inline ::metrics::SystemProfileProto_Hardware_InternalStorageDevice* SystemProfileProto_Hardware::_internal_add_internal_storage_devices() {
  return _impl_.internal_storage_devices_.Add();
}
...
inline bool SystemProfileProto_Hardware::_internal_has_app_drive() const {
  bool value = (_impl_._has_bits_[0] & 0x00000100u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.app_drive_ != nullptr);
  return value;
}
...
inline void SystemProfileProto_Hardware::clear_app_drive() {
  if (_impl_.app_drive_ != nullptr) _impl_.app_drive_->Clear();
  _impl_._has_bits_[0] &= ~0x00000100u;
}
inline const ::metrics::SystemProfileProto_Hardware_Drive& SystemProfileProto_Hardware::_internal_app_drive() const {
  const ::metrics::SystemProfileProto_Hardware_Drive* p = _impl_.app_drive_;
...
inline void SystemProfileProto_Hardware::unsafe_arena_set_allocated_app_drive(
    ::metrics::SystemProfileProto_Hardware_Drive* app_drive) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.app_drive_);
  }
  _impl_.app_drive_ = app_drive;
  if (app_drive) {
    _impl_._has_bits_[0] |= 0x00000100u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000100u;
...
inline ::metrics::SystemProfileProto_Hardware_Drive* SystemProfileProto_Hardware::release_app_drive() {
  _impl_._has_bits_[0] &= ~0x00000100u;
  ::metrics::SystemProfileProto_Hardware_Drive* temp = _impl_.app_drive_;
  _impl_.app_drive_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline bool SystemProfileProto_Hardware::_internal_has_user_data_drive() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.user_data_drive_ != nullptr);
  return value;
}
...
inline void SystemProfileProto_Hardware::clear_user_data_drive() {
  if (_impl_.user_data_drive_ != nullptr) _impl_.user_data_drive_->Clear();
  _impl_._has_bits_[0] &= ~0x00000200u;
}
inline const ::metrics::SystemProfileProto_Hardware_Drive& SystemProfileProto_Hardware::_internal_user_data_drive() const {
  const ::metrics::SystemProfileProto_Hardware_Drive* p = _impl_.user_data_drive_;
  return p != nullptr ? *p : reinterpret_cast<const ::metrics::SystemProfileProto_Hardware_Drive&>(
      ::metrics::_SystemProfileProto_Hardware_Drive_default_instance_);
}
...
inline void SystemProfileProto_Hardware::unsafe_arena_set_allocated_user_data_drive(
    ::metrics::SystemProfileProto_Hardware_Drive* user_data_drive) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.user_data_drive_);
  }
  _impl_.user_data_drive_ = user_data_drive;
  if (user_data_drive) {
    _impl_._has_bits_[0] |= 0x00000200u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000200u;
...
inline ::metrics::SystemProfileProto_Hardware_Drive* SystemProfileProto_Hardware::release_user_data_drive() {
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::metrics::SystemProfileProto_Hardware_Drive* temp = _impl_.user_data_drive_;
  _impl_.user_data_drive_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::metrics::SystemProfileProto_Hardware_Drive* SystemProfileProto_Hardware::_internal_mutable_user_data_drive() {
  _impl_._has_bits_[0] |= 0x00000200u;
  if (_impl_.user_data_drive_ == nullptr) {
    auto* p = CreateMaybeMessage<::metrics::SystemProfileProto_Hardware_Drive>(GetArenaForAllocation());
    _impl_.user_data_drive_ = p;
  }
  return _impl_.user_data_drive_;
}
...
inline void SystemProfileProto_Hardware::set_allocated_user_data_drive(::metrics::SystemProfileProto_Hardware_Drive* user_data_drive) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.user_data_drive_;
  }
  if (user_data_drive) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
inline ::metrics::SystemProfileProto_Hardware_TpmType SystemProfileProto_Hardware::_internal_tpm_type() const {
  return static_cast< ::metrics::SystemProfileProto_Hardware_TpmType >(_impl_.tpm_type_);
}
...
inline void SystemProfileProto_Hardware::_internal_set_tpm_firmware_version(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00200000u;
  _impl_.tpm_firmware_version_ = value;
}
...
inline void SystemProfileProto_Hardware::clear_tpm_rw_firmware_version() {
  _impl_.tpm_rw_firmware_version_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000020u;
}
...
void SystemProfileProto_Hardware::set_tpm_rw_firmware_version(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000020u;
 _impl_.tpm_rw_firmware_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_Hardware::release_tpm_rw_firmware_version() {
  ...
  _impl_._has_bits_[0] &= ~0x00000020u;
  auto* p = _impl_.tpm_rw_firmware_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.tpm_rw_firmware_version_.IsDefault()) {
    _impl_.tpm_rw_firmware_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_Hardware::set_allocated_tpm_rw_firmware_version(std::string* tpm_rw_firmware_version) {
  ...
  _impl_.tpm_rw_firmware_version_.SetAllocated(tpm_rw_firmware_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.tpm_rw_firmware_version_.IsDefault()) {
    _impl_.tpm_rw_firmware_version_.Set("", GetArenaForAllocation());
  }
...
inline void SystemProfileProto_Network::clear_connection_type_is_ambiguous() {
  _impl_.connection_type_is_ambiguous_ = false;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline bool SystemProfileProto_Network::_internal_connection_type_is_ambiguous() const {
  return _impl_.connection_type_is_ambiguous_;
}
...
inline void SystemProfileProto_Network::_internal_set_connection_type_is_ambiguous(bool value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.connection_type_is_ambiguous_ = value;
}
...
inline ::metrics::SystemProfileProto_Network_ConnectionType SystemProfileProto_Network::_internal_connection_type() const {
  return static_cast< ::metrics::SystemProfileProto_Network_ConnectionType >(_impl_.connection_type_);
}
...
inline void SystemProfileProto_Network::clear_min_effective_connection_type() {
  _impl_.min_effective_connection_type_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline ::metrics::SystemProfileProto_Network_EffectiveConnectionType SystemProfileProto_Network::_internal_min_effective_connection_type() const {
  return static_cast< ::metrics::SystemProfileProto_Network_EffectiveConnectionType >(_impl_.min_effective_connection_type_);
}
...
inline void SystemProfileProto_Network::_internal_set_min_effective_connection_type(::metrics::SystemProfileProto_Network_EffectiveConnectionType value) {
  ...
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.min_effective_connection_type_ = value;
}
...
inline void SystemProfileProto_Network::clear_max_effective_connection_type() {
  _impl_.max_effective_connection_type_ = 0;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline ::metrics::SystemProfileProto_Network_EffectiveConnectionType SystemProfileProto_Network::_internal_max_effective_connection_type() const {
  return static_cast< ::metrics::SystemProfileProto_Network_EffectiveConnectionType >(_impl_.max_effective_connection_type_);
}
...
inline void SystemProfileProto_Network::_internal_set_max_effective_connection_type(::metrics::SystemProfileProto_Network_EffectiveConnectionType value) {
  assert(::metrics::SystemProfileProto_Network_EffectiveConnectionType_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.max_effective_connection_type_ = value;
}
...
inline void SystemProfileProto_GoogleUpdate_ProductInfo::_internal_set_last_update_success_timestamp(int64_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.last_update_success_timestamp_ = value;
}
...
inline ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo_InstallResult SystemProfileProto_GoogleUpdate_ProductInfo::_internal_last_result() const {
  return static_cast< ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo_InstallResult >(_impl_.last_result_);
}
...
inline void SystemProfileProto_GoogleUpdate_ProductInfo::_internal_set_last_extra_error(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.last_extra_error_ = value;
}
...
inline void SystemProfileProto_GoogleUpdate::_internal_set_is_system_install(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.is_system_install_ = value;
}
...
inline void SystemProfileProto_GoogleUpdate::clear_last_automatic_start_timestamp() {
  _impl_.last_automatic_start_timestamp_ = int64_t{0};
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int64_t SystemProfileProto_GoogleUpdate::_internal_last_automatic_start_timestamp() const {
  return _impl_.last_automatic_start_timestamp_;
}
...
inline void SystemProfileProto_GoogleUpdate::_internal_set_last_automatic_start_timestamp(int64_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.last_automatic_start_timestamp_ = value;
}
...
inline void SystemProfileProto_GoogleUpdate::_internal_set_last_update_check_timestamp(int64_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.last_update_check_timestamp_ = value;
}
...
inline bool SystemProfileProto_GoogleUpdate::_internal_has_google_update_status() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.google_update_status_ != nullptr);
  return value;
}
...
inline void SystemProfileProto_GoogleUpdate::clear_google_update_status() {
  if (_impl_.google_update_status_ != nullptr) _impl_.google_update_status_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo& SystemProfileProto_GoogleUpdate::_internal_google_update_status() const {
  const ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* p = _impl_.google_update_status_;
...
inline void SystemProfileProto_GoogleUpdate::unsafe_arena_set_allocated_google_update_status(
    ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* google_update_status) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.google_update_status_);
  }
  _impl_.google_update_status_ = google_update_status;
...
inline ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* SystemProfileProto_GoogleUpdate::release_google_update_status() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* temp = _impl_.google_update_status_;
  _impl_.google_update_status_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* SystemProfileProto_GoogleUpdate::_internal_mutable_google_update_status() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.google_update_status_ == nullptr) {
    auto* p = CreateMaybeMessage<::metrics::SystemProfileProto_GoogleUpdate_ProductInfo>(GetArenaForAllocation());
    _impl_.google_update_status_ = p;
  }
  return _impl_.google_update_status_;
}
...
inline void SystemProfileProto_GoogleUpdate::set_allocated_google_update_status(::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* google_update_status) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.google_update_status_;
  }
  if (google_update_status) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
inline void SystemProfileProto_GoogleUpdate::clear_client_status() {
  if (_impl_.client_status_ != nullptr) _impl_.client_status_->Clear();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline const ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo& SystemProfileProto_GoogleUpdate::_internal_client_status() const {
  const ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* p = _impl_.client_status_;
  return p != nullptr ? *p : reinterpret_cast<const ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo&>(
      ::metrics::_SystemProfileProto_GoogleUpdate_ProductInfo_default_instance_);
}
...
inline ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* SystemProfileProto_GoogleUpdate::release_client_status() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::metrics::SystemProfileProto_GoogleUpdate_ProductInfo* temp = _impl_.client_status_;
...
inline void SystemProfileProto_Stability::_internal_set_incremental_uptime_sec(int64_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.incremental_uptime_sec_ = value;
}
...
inline void SystemProfileProto_Stability::_internal_set_renderer_launch_count(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.renderer_launch_count_ = value;
}
...
inline void SystemProfileProto_Stability::_internal_set_other_user_crash_count(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.other_user_crash_count_ = value;
}
...
inline void SystemProfileProto_Stability::_internal_set_kernel_crash_count(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.kernel_crash_count_ = value;
}
...
inline void SystemProfileProto_Stability::_internal_set_unclean_system_shutdown_count(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.unclean_system_shutdown_count_ = value;
}
...
inline void SystemProfileProto_Stability::_internal_set_crash_count_due_to_gms_core_update(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000200u;
  _impl_.crash_count_due_to_gms_core_update_ = value;
}
...
inline void SystemProfileProto_Stability::_internal_set_from_previous_run(bool value) {
  _impl_._has_bits_[0] |= 0x00000100u;
  _impl_.from_previous_run_ = value;
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription_AudioFormat SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_audio_format() const {
  return static_cast< ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription_AudioFormat >(_impl_.audio_format_);
}
...
inline int SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_sample_frequency_hz_size() const {
  return _impl_.sample_frequency_hz_.size();
}
...
inline int32_t SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_sample_frequency_hz(int index) const {
  return _impl_.sample_frequency_hz_.Get(index);
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::set_sample_frequency_hz(int index, int32_t value) {
  _impl_.sample_frequency_hz_.Set(index, value);
...
inline void SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_add_sample_frequency_hz(int32_t value) {
  _impl_.sample_frequency_hz_.Add(value);
}
...
SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_sample_frequency_hz() const {
  return _impl_.sample_frequency_hz_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
...
inline void SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_set_max_bit_rate_per_second(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.max_bit_rate_per_second_ = value;
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription_OutputMode SystemProfileProto_ExternalAudioVideoDevice_AudioDescription::_internal_output_mode() const {
  return static_cast< ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription_OutputMode >(_impl_.output_mode_);
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice_CECCommand::_internal_set_num_received_direct(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.num_received_direct_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice_CECCommand::_internal_set_num_received_broadcast(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.num_received_broadcast_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice_CECCommand::_internal_set_num_sent_broadcast(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.num_sent_broadcast_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice_CECCommand::_internal_set_num_aborted_unknown_reason(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.num_aborted_unknown_reason_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice_CECCommand::_internal_set_num_aborted_unrecognized(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.num_aborted_unrecognized_ = value;
}
...
inline std::string* SystemProfileProto_ExternalAudioVideoDevice::release_manufacturer_name() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.manufacturer_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void SystemProfileProto_ExternalAudioVideoDevice::clear_product_code() {
  _impl_.product_code_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
...
void SystemProfileProto_ExternalAudioVideoDevice::set_product_code(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.product_code_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_ExternalAudioVideoDevice::release_product_code() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.product_code_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.product_code_.IsDefault()) {
...
inline void SystemProfileProto_ExternalAudioVideoDevice::set_allocated_product_code(std::string* product_code) {
  ...
  _impl_.product_code_.SetAllocated(product_code, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.product_code_.IsDefault()) {
    _impl_.product_code_.Set("", GetArenaForAllocation());
  }
...
inline int SystemProfileProto_ExternalAudioVideoDevice::_internal_av_device_type_size() const {
  return _impl_.av_device_type_.size();
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AVDeviceType SystemProfileProto_ExternalAudioVideoDevice::_internal_av_device_type(int index) const {
  return static_cast< ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AVDeviceType >(_impl_.av_device_type_.Get(index));
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::set_av_device_type(int index, ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AVDeviceType value) {
  ...
  _impl_.av_device_type_.Set(index, value);
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_add_av_device_type(::metrics::SystemProfileProto_ExternalAudioVideoDevice_AVDeviceType value) {
  assert(::metrics::SystemProfileProto_ExternalAudioVideoDevice_AVDeviceType_IsValid(value));
  _impl_.av_device_type_.Add(value);
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_set_manufacture_week(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.manufacture_week_ = value;
}
...
inline int SystemProfileProto_ExternalAudioVideoDevice::_internal_audio_description_size() const {
  return _impl_.audio_description_.size();
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription* SystemProfileProto_ExternalAudioVideoDevice::mutable_audio_description(int index) {
  ...
  return _impl_.audio_description_.Mutable(index);
}
...
SystemProfileProto_ExternalAudioVideoDevice::mutable_audio_description() {
  ...
  return &_impl_.audio_description_;
}
inline const ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription& SystemProfileProto_ExternalAudioVideoDevice::_internal_audio_description(int index) const {
  return _impl_.audio_description_.Get(index);
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_AudioDescription* SystemProfileProto_ExternalAudioVideoDevice::_internal_add_audio_description() {
  return _impl_.audio_description_.Add();
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_set_position_in_setup(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.position_in_setup_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_set_is_in_path_to_tv(bool value) {
  _impl_._has_bits_[0] |= 0x00002000u;
  _impl_.is_in_path_to_tv_ = value;
}
...
inline int SystemProfileProto_ExternalAudioVideoDevice::_internal_cec_command_size() const {
  return _impl_.cec_command_.size();
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_CECCommand* SystemProfileProto_ExternalAudioVideoDevice::mutable_cec_command(int index) {
  ...
  return _impl_.cec_command_.Mutable(index);
}
...
inline const ::metrics::SystemProfileProto_ExternalAudioVideoDevice_CECCommand& SystemProfileProto_ExternalAudioVideoDevice::_internal_cec_command(int index) const {
  return _impl_.cec_command_.Get(index);
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_CECCommand* SystemProfileProto_ExternalAudioVideoDevice::_internal_add_cec_command() {
  return _impl_.cec_command_.Add();
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice_ColorEncoding SystemProfileProto_ExternalAudioVideoDevice::_internal_color_encoding() const {
  return static_cast< ::metrics::SystemProfileProto_ExternalAudioVideoDevice_ColorEncoding >(_impl_.color_encoding_);
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_set_dolby_vision_support(bool value) {
  _impl_._has_bits_[0] |= 0x00008000u;
  _impl_.dolby_vision_support_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_set_maximum_supported_hdcp_version(int32_t value) {
  _impl_._has_bits_[0] |= 0x00080000u;
  _impl_.maximum_supported_hdcp_version_ = value;
}
...
inline void SystemProfileProto_ExternalAudioVideoDevice::_internal_set_current_hdcp_version(int32_t value) {
  _impl_._has_bits_[0] |= 0x00100000u;
  _impl_.current_hdcp_version_ = value;
}
...
inline std::string* SystemProfileProto_ExternalAccessPoint::release_model_number() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.model_number_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void SystemProfileProto_AntiVirusProduct::_internal_set_product_name_hash(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.product_name_hash_ = value;
}
...
inline void SystemProfileProto_AntiVirusProduct::_internal_set_product_version_hash(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.product_version_hash_ = value;
}
...
inline ::metrics::SystemProfileProto_ComponentId SystemProfileProto_ChromeComponent::_internal_component_id() const {
  return static_cast< ::metrics::SystemProfileProto_ComponentId >(_impl_.component_id_);
}
...
inline void SystemProfileProto_ChromeComponent::_internal_set_omaha_fingerprint(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.omaha_fingerprint_ = value;
}
...
inline void SystemProfileProto_LinkedAndroidPhoneData::_internal_set_phone_model_name_hash(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.phone_model_name_hash_ = value;
}
...
inline void SystemProfileProto_LinkedAndroidPhoneData::_internal_set_is_smartlock_enabled(bool value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.is_smartlock_enabled_ = value;
}
...
inline void SystemProfileProto_LinkedAndroidPhoneData::_internal_set_is_instant_tethering_enabled(bool value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.is_instant_tethering_enabled_ = value;
}
...
inline void SystemProfileProto_LinkedAndroidPhoneData::_internal_set_is_messages_enabled(bool value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.is_messages_enabled_ = value;
}
...
inline void SystemProfileProto_DemoModeDimensions_Retailer::clear_retailer_id() {
  _impl_.retailer_id_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
...
void SystemProfileProto_DemoModeDimensions_Retailer::set_retailer_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.retailer_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_DemoModeDimensions_Retailer::release_retailer_id() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.retailer_id_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.retailer_id_.IsDefault()) {
    _impl_.retailer_id_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_DemoModeDimensions_Retailer::set_allocated_retailer_id(std::string* retailer_id) {
  ...
  _impl_.retailer_id_.SetAllocated(retailer_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.retailer_id_.IsDefault()) {
    _impl_.retailer_id_.Set("", GetArenaForAllocation());
  }
...
inline std::string* SystemProfileProto_DemoModeDimensions_Retailer::release_store_id() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.store_id_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline bool SystemProfileProto_DemoModeDimensions::_internal_has_retailer() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.retailer_ != nullptr);
  return value;
}
...
inline void SystemProfileProto_DemoModeDimensions::clear_retailer() {
  if (_impl_.retailer_ != nullptr) _impl_.retailer_->Clear();
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline const ::metrics::SystemProfileProto_DemoModeDimensions_Retailer& SystemProfileProto_DemoModeDimensions::_internal_retailer() const {
  const ::metrics::SystemProfileProto_DemoModeDimensions_Retailer* p = _impl_.retailer_;
...
inline void SystemProfileProto_DemoModeDimensions::unsafe_arena_set_allocated_retailer(
    ::metrics::SystemProfileProto_DemoModeDimensions_Retailer* retailer) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.retailer_);
  }
  _impl_.retailer_ = retailer;
  if (retailer) {
    _impl_._has_bits_[0] |= 0x00000008u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000008u;
...
inline ::metrics::SystemProfileProto_DemoModeDimensions_Retailer* SystemProfileProto_DemoModeDimensions::release_retailer() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::metrics::SystemProfileProto_DemoModeDimensions_Retailer* temp = _impl_.retailer_;
  _impl_.retailer_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline int SystemProfileProto_DemoModeDimensions::_internal_customization_facet_size() const {
  return _impl_.customization_facet_.size();
}
...
inline ::metrics::SystemProfileProto_DemoModeDimensions_CustomizationFacet SystemProfileProto_DemoModeDimensions::_internal_customization_facet(int index) const {
  return static_cast< ::metrics::SystemProfileProto_DemoModeDimensions_CustomizationFacet >(_impl_.customization_facet_.Get(index));
}
...
inline void SystemProfileProto_DemoModeDimensions::set_customization_facet(int index, ::metrics::SystemProfileProto_DemoModeDimensions_CustomizationFacet value) {
  ...
  _impl_.customization_facet_.Set(index, value);
...
inline void SystemProfileProto_DemoModeDimensions::_internal_add_customization_facet(::metrics::SystemProfileProto_DemoModeDimensions_CustomizationFacet value) {
  assert(::metrics::SystemProfileProto_DemoModeDimensions_CustomizationFacet_IsValid(value));
  _impl_.customization_facet_.Add(value);
}
...
SystemProfileProto_DemoModeDimensions::customization_facet() const {
  ...
  return _impl_.customization_facet_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>*
...
inline void SystemProfileProto_DemoModeDimensions::clear_resources_version() {
  _impl_.resources_version_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
...
void SystemProfileProto_DemoModeDimensions::set_resources_version(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.resources_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto_DemoModeDimensions::release_resources_version() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.resources_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.resources_version_.IsDefault()) {
    _impl_.resources_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_DemoModeDimensions::set_allocated_resources_version(std::string* resources_version) {
  ...
  _impl_.resources_version_.SetAllocated(resources_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.resources_version_.IsDefault()) {
    _impl_.resources_version_.Set("", GetArenaForAllocation());
  }
...
// optional fixed32 manufacturer_id = 1;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_manufacturer_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_manufacturer_id() const {
  return _internal_has_manufacturer_id();
}
inline void SystemProfileProto_TpmIdentifier::clear_manufacturer_id() {
  _impl_.manufacturer_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline uint32_t SystemProfileProto_TpmIdentifier::_internal_manufacturer_id() const {
  return _impl_.manufacturer_id_;
}
inline uint32_t SystemProfileProto_TpmIdentifier::manufacturer_id() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.manufacturer_id)
  return _internal_manufacturer_id();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_manufacturer_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.manufacturer_id_ = value;
}
inline void SystemProfileProto_TpmIdentifier::set_manufacturer_id(uint32_t value) {
  _internal_set_manufacturer_id(value);
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.manufacturer_id)
}

// optional string manufacturer_version = 2;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_manufacturer_version() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_manufacturer_version() const {
  return _internal_has_manufacturer_version();
}
inline void SystemProfileProto_TpmIdentifier::clear_manufacturer_version() {
  _impl_.manufacturer_version_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& SystemProfileProto_TpmIdentifier::manufacturer_version() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version)
  return _internal_manufacturer_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SystemProfileProto_TpmIdentifier::set_manufacturer_version(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.manufacturer_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version)
}
inline std::string* SystemProfileProto_TpmIdentifier::mutable_manufacturer_version() {
  std::string* _s = _internal_mutable_manufacturer_version();
  // @@protoc_insertion_point(field_mutable:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version)
  return _s;
}
inline const std::string& SystemProfileProto_TpmIdentifier::_internal_manufacturer_version() const {
  return _impl_.manufacturer_version_.Get();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_manufacturer_version(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.manufacturer_version_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto_TpmIdentifier::_internal_mutable_manufacturer_version() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.manufacturer_version_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto_TpmIdentifier::release_manufacturer_version() {
  // @@protoc_insertion_point(field_release:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version)
  if (!_internal_has_manufacturer_version()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.manufacturer_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.manufacturer_version_.IsDefault()) {
    _impl_.manufacturer_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_TpmIdentifier::set_allocated_manufacturer_version(std::string* manufacturer_version) {
  if (manufacturer_version != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  _impl_.manufacturer_version_.SetAllocated(manufacturer_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.manufacturer_version_.IsDefault()) {
    _impl_.manufacturer_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version)
}

// optional fixed32 manufacturer_version_hash = 3;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_manufacturer_version_hash() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_manufacturer_version_hash() const {
  return _internal_has_manufacturer_version_hash();
}
inline void SystemProfileProto_TpmIdentifier::clear_manufacturer_version_hash() {
  _impl_.manufacturer_version_hash_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline uint32_t SystemProfileProto_TpmIdentifier::_internal_manufacturer_version_hash() const {
  return _impl_.manufacturer_version_hash_;
}
inline uint32_t SystemProfileProto_TpmIdentifier::manufacturer_version_hash() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_hash)
  return _internal_manufacturer_version_hash();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_manufacturer_version_hash(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.manufacturer_version_hash_ = value;
}
inline void SystemProfileProto_TpmIdentifier::set_manufacturer_version_hash(uint32_t value) {
  _internal_set_manufacturer_version_hash(value);
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_hash)
}

// optional string manufacturer_version_info = 4;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_manufacturer_version_info() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_manufacturer_version_info() const {
  return _internal_has_manufacturer_version_info();
}
inline void SystemProfileProto_TpmIdentifier::clear_manufacturer_version_info() {
  _impl_.manufacturer_version_info_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline const std::string& SystemProfileProto_TpmIdentifier::manufacturer_version_info() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info)
  return _internal_manufacturer_version_info();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SystemProfileProto_TpmIdentifier::set_manufacturer_version_info(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.manufacturer_version_info_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info)
}
inline std::string* SystemProfileProto_TpmIdentifier::mutable_manufacturer_version_info() {
  std::string* _s = _internal_mutable_manufacturer_version_info();
  // @@protoc_insertion_point(field_mutable:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info)
  return _s;
}
inline const std::string& SystemProfileProto_TpmIdentifier::_internal_manufacturer_version_info() const {
  return _impl_.manufacturer_version_info_.Get();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_manufacturer_version_info(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.manufacturer_version_info_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto_TpmIdentifier::_internal_mutable_manufacturer_version_info() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.manufacturer_version_info_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto_TpmIdentifier::release_manufacturer_version_info() {
  // @@protoc_insertion_point(field_release:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info)
  if (!_internal_has_manufacturer_version_info()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.manufacturer_version_info_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.manufacturer_version_info_.IsDefault()) {
    _impl_.manufacturer_version_info_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_TpmIdentifier::set_allocated_manufacturer_version_info(std::string* manufacturer_version_info) {
  if (manufacturer_version_info != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
  }
  _impl_.manufacturer_version_info_.SetAllocated(manufacturer_version_info, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.manufacturer_version_info_.IsDefault()) {
    _impl_.manufacturer_version_info_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info)
}

// optional fixed32 manufacturer_version_info_hash = 5;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_manufacturer_version_info_hash() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_manufacturer_version_info_hash() const {
  return _internal_has_manufacturer_version_info_hash();
}
inline void SystemProfileProto_TpmIdentifier::clear_manufacturer_version_info_hash() {
  _impl_.manufacturer_version_info_hash_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline uint32_t SystemProfileProto_TpmIdentifier::_internal_manufacturer_version_info_hash() const {
  return _impl_.manufacturer_version_info_hash_;
}
inline uint32_t SystemProfileProto_TpmIdentifier::manufacturer_version_info_hash() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info_hash)
  return _internal_manufacturer_version_info_hash();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_manufacturer_version_info_hash(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.manufacturer_version_info_hash_ = value;
}
inline void SystemProfileProto_TpmIdentifier::set_manufacturer_version_info_hash(uint32_t value) {
  _internal_set_manufacturer_version_info_hash(value);
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.manufacturer_version_info_hash)
}

// optional string tpm_specific_version = 6;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_tpm_specific_version() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_tpm_specific_version() const {
  return _internal_has_tpm_specific_version();
}
inline void SystemProfileProto_TpmIdentifier::clear_tpm_specific_version() {
  _impl_.tpm_specific_version_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline const std::string& SystemProfileProto_TpmIdentifier::tpm_specific_version() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version)
  return _internal_tpm_specific_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SystemProfileProto_TpmIdentifier::set_tpm_specific_version(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.tpm_specific_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version)
}
inline std::string* SystemProfileProto_TpmIdentifier::mutable_tpm_specific_version() {
  std::string* _s = _internal_mutable_tpm_specific_version();
  // @@protoc_insertion_point(field_mutable:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version)
  return _s;
}
inline const std::string& SystemProfileProto_TpmIdentifier::_internal_tpm_specific_version() const {
  return _impl_.tpm_specific_version_.Get();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_tpm_specific_version(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.tpm_specific_version_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto_TpmIdentifier::_internal_mutable_tpm_specific_version() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.tpm_specific_version_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto_TpmIdentifier::release_tpm_specific_version() {
  // @@protoc_insertion_point(field_release:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version)
  if (!_internal_has_tpm_specific_version()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.tpm_specific_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.tpm_specific_version_.IsDefault()) {
    _impl_.tpm_specific_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto_TpmIdentifier::set_allocated_tpm_specific_version(std::string* tpm_specific_version) {
  if (tpm_specific_version != nullptr) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
  }
  _impl_.tpm_specific_version_.SetAllocated(tpm_specific_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.tpm_specific_version_.IsDefault()) {
    _impl_.tpm_specific_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version)
}

// optional fixed32 tpm_specific_version_hash = 7;
inline bool SystemProfileProto_TpmIdentifier::_internal_has_tpm_specific_version_hash() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool SystemProfileProto_TpmIdentifier::has_tpm_specific_version_hash() const {
  return _internal_has_tpm_specific_version_hash();
}
inline void SystemProfileProto_TpmIdentifier::clear_tpm_specific_version_hash() {
  _impl_.tpm_specific_version_hash_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline uint32_t SystemProfileProto_TpmIdentifier::_internal_tpm_specific_version_hash() const {
  return _impl_.tpm_specific_version_hash_;
}
inline uint32_t SystemProfileProto_TpmIdentifier::tpm_specific_version_hash() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version_hash)
  return _internal_tpm_specific_version_hash();
}
inline void SystemProfileProto_TpmIdentifier::_internal_set_tpm_specific_version_hash(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.tpm_specific_version_hash_ = value;
}
inline void SystemProfileProto_TpmIdentifier::set_tpm_specific_version_hash(uint32_t value) {
  _internal_set_tpm_specific_version_hash(value);
  // @@protoc_insertion_point(field_set:metrics.SystemProfileProto.TpmIdentifier.tpm_specific_version_hash)
}
...
inline void SystemProfileProto::clear_log_written_by_app_version() {
  _impl_.log_written_by_app_version_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000040u;
}
...
void SystemProfileProto::set_log_written_by_app_version(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000040u;
 _impl_.log_written_by_app_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& SystemProfileProto::_internal_log_written_by_app_version() const {
  return _impl_.log_written_by_app_version_.Get();
}
inline void SystemProfileProto::_internal_set_log_written_by_app_version(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.log_written_by_app_version_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto::_internal_mutable_log_written_by_app_version() {
  _impl_._has_bits_[0] |= 0x00000040u;
  return _impl_.log_written_by_app_version_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto::release_log_written_by_app_version() {
  ...
  _impl_._has_bits_[0] &= ~0x00000040u;
  auto* p = _impl_.log_written_by_app_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.log_written_by_app_version_.IsDefault()) {
    _impl_.log_written_by_app_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto::set_allocated_log_written_by_app_version(std::string* log_written_by_app_version) {
  ...
  _impl_.log_written_by_app_version_.SetAllocated(log_written_by_app_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.log_written_by_app_version_.IsDefault()) {
    _impl_.log_written_by_app_version_.Set("", GetArenaForAllocation());
  }
...
inline ::metrics::SystemProfileProto_Channel SystemProfileProto::_internal_channel() const {
  return static_cast< ::metrics::SystemProfileProto_Channel >(_impl_.channel_);
}
...
inline void SystemProfileProto::_internal_set_is_instrumented_build(bool value) {
  _impl_._has_bits_[0] |= 0x02000000u;
  _impl_.is_instrumented_build_ = value;
}
...
inline void SystemProfileProto::_internal_set_uma_enabled_date(int64_t value) {
  _impl_._has_bits_[0] |= 0x00040000u;
  _impl_.uma_enabled_date_ = value;
}
...
inline bool SystemProfileProto::_internal_has_cloned_install_info() const {
  bool value = (_impl_._has_bits_[0] & 0x00004000u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.cloned_install_info_ != nullptr);
  return value;
}
...
inline void SystemProfileProto::clear_cloned_install_info() {
  if (_impl_.cloned_install_info_ != nullptr) _impl_.cloned_install_info_->Clear();
  _impl_._has_bits_[0] &= ~0x00004000u;
}
inline const ::metrics::SystemProfileProto_ClonedInstallInfo& SystemProfileProto::_internal_cloned_install_info() const {
  const ::metrics::SystemProfileProto_ClonedInstallInfo* p = _impl_.cloned_install_info_;
...
inline void SystemProfileProto::unsafe_arena_set_allocated_cloned_install_info(
    ::metrics::SystemProfileProto_ClonedInstallInfo* cloned_install_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.cloned_install_info_);
  }
  _impl_.cloned_install_info_ = cloned_install_info;
...
inline ::metrics::SystemProfileProto_ClonedInstallInfo* SystemProfileProto::release_cloned_install_info() {
  _impl_._has_bits_[0] &= ~0x00004000u;
  ::metrics::SystemProfileProto_ClonedInstallInfo* temp = _impl_.cloned_install_info_;
  _impl_.cloned_install_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::metrics::SystemProfileProto_ClonedInstallInfo* SystemProfileProto::_internal_mutable_cloned_install_info() {
  _impl_._has_bits_[0] |= 0x00004000u;
  if (_impl_.cloned_install_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::metrics::SystemProfileProto_ClonedInstallInfo>(GetArenaForAllocation());
    _impl_.cloned_install_info_ = p;
  }
  return _impl_.cloned_install_info_;
}
...
inline void SystemProfileProto::set_allocated_cloned_install_info(::metrics::SystemProfileProto_ClonedInstallInfo* cloned_install_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.cloned_install_info_;
  }
  if (cloned_install_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
inline void SystemProfileProto::_internal_set_low_entropy_source(int32_t value) {
  _impl_._has_bits_[0] |= 0x08000000u;
  _impl_.low_entropy_source_ = value;
}
...
inline void SystemProfileProto::_internal_set_old_low_entropy_source(int32_t value) {
  _impl_._has_bits_[0] |= 0x10000000u;
  _impl_.old_low_entropy_source_ = value;
}
...
inline void SystemProfileProto::_internal_set_pseudo_low_entropy_source(int32_t value) {
  _impl_._has_bits_[0] |= 0x40000000u;
  _impl_.pseudo_low_entropy_source_ = value;
}
...
inline void SystemProfileProto::clear_application_locale() {
  _impl_.application_locale_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
...
void SystemProfileProto::set_application_locale(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.application_locale_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemProfileProto::release_application_locale() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.application_locale_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.application_locale_.IsDefault()) {
...
inline void SystemProfileProto::set_allocated_application_locale(std::string* application_locale) {
  ...
  _impl_.application_locale_.SetAllocated(application_locale, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.application_locale_.IsDefault()) {
    _impl_.application_locale_.Set("", GetArenaForAllocation());
  }
...
inline int SystemProfileProto::_internal_command_line_key_hash_size() const {
  return _impl_.command_line_key_hash_.size();
}
...
inline uint32_t SystemProfileProto::_internal_command_line_key_hash(int index) const {
  return _impl_.command_line_key_hash_.Get(index);
}
...
inline void SystemProfileProto::set_command_line_key_hash(int index, uint32_t value) {
  _impl_.command_line_key_hash_.Set(index, value);
...
inline void SystemProfileProto::_internal_add_command_line_key_hash(uint32_t value) {
  _impl_.command_line_key_hash_.Add(value);
}
...
SystemProfileProto::_internal_command_line_key_hash() const {
  return _impl_.command_line_key_hash_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
...
inline const ::metrics::SystemProfileProto_OS& SystemProfileProto::_internal_os() const {
  const ::metrics::SystemProfileProto_OS* p = _impl_.os_;
...
inline ::metrics::SystemProfileProto_OS* SystemProfileProto::release_os() {
  _impl_._has_bits_[0] &= ~0x00000080u;
  ::metrics::SystemProfileProto_OS* temp = _impl_.os_;
  _impl_.os_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline const ::metrics::SystemProfileProto_Hardware& SystemProfileProto::_internal_hardware() const {
  const ::metrics::SystemProfileProto_Hardware* p = _impl_.hardware_;
...
inline ::metrics::SystemProfileProto_Hardware* SystemProfileProto::release_hardware() {
  _impl_._has_bits_[0] &= ~0x00000100u;
  ::metrics::SystemProfileProto_Hardware* temp = _impl_.hardware_;
...
inline const ::metrics::SystemProfileProto_Network& SystemProfileProto::_internal_network() const {
  const ::metrics::SystemProfileProto_Network* p = _impl_.network_;
...
inline ::metrics::SystemProfileProto_Network* SystemProfileProto::release_network() {
  _impl_._has_bits_[0] &= ~0x00000800u;
  ::metrics::SystemProfileProto_Network* temp = _impl_.network_;
...
inline bool SystemProfileProto::_internal_has_google_update() const {
  bool value = (_impl_._has_bits_[0] & 0x00000400u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.google_update_ != nullptr);
  return value;
}
...
inline void SystemProfileProto::clear_google_update() {
  if (_impl_.google_update_ != nullptr) _impl_.google_update_->Clear();
  _impl_._has_bits_[0] &= ~0x00000400u;
}
inline const ::metrics::SystemProfileProto_GoogleUpdate& SystemProfileProto::_internal_google_update() const {
  const ::metrics::SystemProfileProto_GoogleUpdate* p = _impl_.google_update_;
...
inline void SystemProfileProto::unsafe_arena_set_allocated_google_update(
    ::metrics::SystemProfileProto_GoogleUpdate* google_update) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.google_update_);
  }
  _impl_.google_update_ = google_update;
  if (google_update) {
    _impl_._has_bits_[0] |= 0x00000400u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000400u;
...
inline ::metrics::SystemProfileProto_GoogleUpdate* SystemProfileProto::release_google_update() {
  _impl_._has_bits_[0] &= ~0x00000400u;
  ::metrics::SystemProfileProto_GoogleUpdate* temp = _impl_.google_update_;
  _impl_.google_update_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline const ::metrics::SystemProfileProto_Stability& SystemProfileProto::_internal_stability() const {
  const ::metrics::SystemProfileProto_Stability* p = _impl_.stability_;
...
inline void SystemProfileProto::unsafe_arena_set_allocated_stability(
    ::metrics::SystemProfileProto_Stability* stability) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.stability_);
  }
  _impl_.stability_ = stability;
  if (stability) {
    _impl_._has_bits_[0] |= 0x00000200u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000200u;
...
inline ::metrics::SystemProfileProto_Stability* SystemProfileProto::release_stability() {
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::metrics::SystemProfileProto_Stability* temp = _impl_.stability_;
...
inline int SystemProfileProto::_internal_field_trial_size() const {
  return _impl_.field_trial_.size();
}
...
inline ::metrics::SystemProfileProto_FieldTrial* SystemProfileProto::mutable_field_trial(int index) {
  ...
  return _impl_.field_trial_.Mutable(index);
}
...
inline ::metrics::SystemProfileProto_FieldTrial* SystemProfileProto::_internal_add_field_trial() {
  return _impl_.field_trial_.Add();
}
...
inline void SystemProfileProto::clear_variations_seed_version() {
  _impl_.variations_seed_version_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000010u;
}
...
void SystemProfileProto::set_variations_seed_version(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000010u;
 _impl_.variations_seed_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& SystemProfileProto::_internal_variations_seed_version() const {
  return _impl_.variations_seed_version_.Get();
}
inline void SystemProfileProto::_internal_set_variations_seed_version(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.variations_seed_version_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto::_internal_mutable_variations_seed_version() {
  _impl_._has_bits_[0] |= 0x00000010u;
  return _impl_.variations_seed_version_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto::release_variations_seed_version() {
  ...
  _impl_._has_bits_[0] &= ~0x00000010u;
  auto* p = _impl_.variations_seed_version_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.variations_seed_version_.IsDefault()) {
    _impl_.variations_seed_version_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto::set_allocated_variations_seed_version(std::string* variations_seed_version) {
  ...
  _impl_.variations_seed_version_.SetAllocated(variations_seed_version, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.variations_seed_version_.IsDefault()) {
    _impl_.variations_seed_version_.Set("", GetArenaForAllocation());
  }
...
inline void SystemProfileProto::clear_client_id_was_used_for_trial_assignment() {
  _impl_.client_id_was_used_for_trial_assignment_ = false;
  _impl_._has_bits_[0] &= ~0x04000000u;
}
inline bool SystemProfileProto::_internal_client_id_was_used_for_trial_assignment() const {
  return _impl_.client_id_was_used_for_trial_assignment_;
}
...
inline void SystemProfileProto::_internal_set_client_id_was_used_for_trial_assignment(bool value) {
  _impl_._has_bits_[0] |= 0x04000000u;
  _impl_.client_id_was_used_for_trial_assignment_ = value;
}
...
void SystemProfileProto::set_client_uuid(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000020u;
 _impl_.client_uuid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SystemProfileProto::_internal_set_client_uuid(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.client_uuid_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto::_internal_mutable_client_uuid() {
  _impl_._has_bits_[0] |= 0x00000020u;
  return _impl_.client_uuid_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto::release_client_uuid() {
  ...
  _impl_._has_bits_[0] &= ~0x00000020u;
  auto* p = _impl_.client_uuid_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.client_uuid_.IsDefault()) {
    _impl_.client_uuid_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto::set_allocated_client_uuid(std::string* client_uuid) {
  ...
  _impl_.client_uuid_.SetAllocated(client_uuid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.client_uuid_.IsDefault()) {
    _impl_.client_uuid_.Set("", GetArenaForAllocation());
  }
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice* SystemProfileProto::mutable_external_audio_video_device(int index) {
  ...
  return _impl_.external_audio_video_device_.Mutable(index);
}
...
SystemProfileProto::mutable_external_audio_video_device() {
  ...
  return &_impl_.external_audio_video_device_;
}
inline const ::metrics::SystemProfileProto_ExternalAudioVideoDevice& SystemProfileProto::_internal_external_audio_video_device(int index) const {
  return _impl_.external_audio_video_device_.Get(index);
}
...
inline ::metrics::SystemProfileProto_ExternalAudioVideoDevice* SystemProfileProto::_internal_add_external_audio_video_device() {
  return _impl_.external_audio_video_device_.Add();
}
...
inline bool SystemProfileProto::_internal_has_external_access_point() const {
  bool value = (_impl_._has_bits_[0] & 0x00001000u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.external_access_point_ != nullptr);
  return value;
}
...
inline void SystemProfileProto::clear_external_access_point() {
  if (_impl_.external_access_point_ != nullptr) _impl_.external_access_point_->Clear();
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline const ::metrics::SystemProfileProto_ExternalAccessPoint& SystemProfileProto::_internal_external_access_point() const {
  const ::metrics::SystemProfileProto_ExternalAccessPoint* p = _impl_.external_access_point_;
...
inline void SystemProfileProto::unsafe_arena_set_allocated_external_access_point(
    ::metrics::SystemProfileProto_ExternalAccessPoint* external_access_point) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.external_access_point_);
  }
  _impl_.external_access_point_ = external_access_point;
...
inline ::metrics::SystemProfileProto_ExternalAccessPoint* SystemProfileProto::release_external_access_point() {
  _impl_._has_bits_[0] &= ~0x00001000u;
  ::metrics::SystemProfileProto_ExternalAccessPoint* temp = _impl_.external_access_point_;
  _impl_.external_access_point_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::metrics::SystemProfileProto_ExternalAccessPoint* SystemProfileProto::_internal_mutable_external_access_point() {
  _impl_._has_bits_[0] |= 0x00001000u;
  if (_impl_.external_access_point_ == nullptr) {
    auto* p = CreateMaybeMessage<::metrics::SystemProfileProto_ExternalAccessPoint>(GetArenaForAllocation());
    _impl_.external_access_point_ = p;
  }
  return _impl_.external_access_point_;
}
...
inline void SystemProfileProto::set_allocated_external_access_point(::metrics::SystemProfileProto_ExternalAccessPoint* external_access_point) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.external_access_point_;
  }
  if (external_access_point) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
inline void SystemProfileProto::_internal_set_multi_profile_user_count(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00100000u;
  _impl_.multi_profile_user_count_ = value;
}
...
inline int SystemProfileProto::_internal_occupied_extension_bucket_size() const {
  return _impl_.occupied_extension_bucket_.size();
}
...
inline int32_t SystemProfileProto::_internal_occupied_extension_bucket(int index) const {
  return _impl_.occupied_extension_bucket_.Get(index);
}
...
inline void SystemProfileProto::set_occupied_extension_bucket(int index, int32_t value) {
  _impl_.occupied_extension_bucket_.Set(index, value);
...
inline void SystemProfileProto::_internal_add_occupied_extension_bucket(int32_t value) {
  _impl_.occupied_extension_bucket_.Add(value);
}
...
SystemProfileProto::_internal_occupied_extension_bucket() const {
  return _impl_.occupied_extension_bucket_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
...
inline void SystemProfileProto::clear_offstore_extensions_state() {
  _impl_.offstore_extensions_state_ = 0;
  _impl_._has_bits_[0] &= ~0x00400000u;
}
inline ::metrics::SystemProfileProto_ExtensionsState SystemProfileProto::_internal_offstore_extensions_state() const {
  return static_cast< ::metrics::SystemProfileProto_ExtensionsState >(_impl_.offstore_extensions_state_);
}
...
inline void SystemProfileProto::_internal_set_offstore_extensions_state(::metrics::SystemProfileProto_ExtensionsState value) {
  ...
  _impl_._has_bits_[0] |= 0x00400000u;
  _impl_.offstore_extensions_state_ = value;
}
...
inline void SystemProfileProto::clear_uma_default_state() {
  _impl_.uma_default_state_ = 0;
  _impl_._has_bits_[0] &= ~0x00800000u;
}
inline ::metrics::SystemProfileProto_UmaDefaultState SystemProfileProto::_internal_uma_default_state() const {
  return static_cast< ::metrics::SystemProfileProto_UmaDefaultState >(_impl_.uma_default_state_);
}
...
inline void SystemProfileProto::_internal_set_uma_default_state(::metrics::SystemProfileProto_UmaDefaultState value) {
  ...
  _impl_._has_bits_[0] |= 0x00800000u;
  _impl_.uma_default_state_ = value;
}
...
inline int SystemProfileProto::_internal_antivirus_product_size() const {
  return _impl_.antivirus_product_.size();
}
...
inline ::metrics::SystemProfileProto_AntiVirusProduct* SystemProfileProto::mutable_antivirus_product(int index) {
  ...
  return _impl_.antivirus_product_.Mutable(index);
}
...
inline ::metrics::SystemProfileProto_AntiVirusProduct* SystemProfileProto::_internal_add_antivirus_product() {
  return _impl_.antivirus_product_.Add();
}
...
inline int SystemProfileProto::_internal_chrome_component_size() const {
  return _impl_.chrome_component_.size();
}
...
inline ::metrics::SystemProfileProto_ChromeComponent* SystemProfileProto::mutable_chrome_component(int index) {
  ...
  return _impl_.chrome_component_.Mutable(index);
}
...
inline ::metrics::SystemProfileProto_ChromeComponent* SystemProfileProto::_internal_add_chrome_component() {
  return _impl_.chrome_component_.Add();
}
...
inline int SystemProfileProto::_internal_extension_install_size() const {
  return _impl_.extension_install_.size();
}
...
inline ::metrics::ExtensionInstallProto* SystemProfileProto::mutable_extension_install(int index) {
  ...
  return _impl_.extension_install_.Mutable(index);
}
...
inline ::metrics::ExtensionInstallProto* SystemProfileProto::_internal_add_extension_install() {
  return _impl_.extension_install_.Add();
}
...
void SystemProfileProto::set_app_package_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.app_package_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SystemProfileProto::_internal_set_app_package_name(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.app_package_name_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemProfileProto::_internal_mutable_app_package_name() {
  _impl_._has_bits_[0] |= 0x00000008u;
  return _impl_.app_package_name_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemProfileProto::release_app_package_name() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.app_package_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.app_package_name_.IsDefault()) {
    _impl_.app_package_name_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void SystemProfileProto::set_allocated_app_package_name(std::string* app_package_name) {
  ...
  _impl_.app_package_name_.SetAllocated(app_package_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.app_package_name_.IsDefault()) {
    _impl_.app_package_name_.Set("", GetArenaForAllocation());
  }
...
inline void SystemProfileProto::clear_app_package_name_allowlist_filter() {
  _impl_.app_package_name_allowlist_filter_ = 0;
...
inline ::metrics::SystemProfileProto_AppPackageNameAllowlistFilter SystemProfileProto::_internal_app_package_name_allowlist_filter() const {
  return static_cast< ::metrics::SystemProfileProto_AppPackageNameAllowlistFilter >(_impl_.app_package_name_allowlist_filter_);
}
...
inline void SystemProfileProto::_internal_set_app_package_name_allowlist_filter(::metrics::SystemProfileProto_AppPackageNameAllowlistFilter value) {
  ...
  _impl_._has_bits_[0] |= 0x80000000u;
  _impl_.app_package_name_allowlist_filter_ = value;
}
...
inline void SystemProfileProto::clear_client_side_sampling_status() {
  _impl_.client_side_sampling_status_ = 0;
...
inline ::metrics::SystemProfileProto_ClientSideSamplingStatus SystemProfileProto::_internal_client_side_sampling_status() const {
  return static_cast< ::metrics::SystemProfileProto_ClientSideSamplingStatus >(_impl_.client_side_sampling_status_);
}
...
inline void SystemProfileProto::_internal_set_client_side_sampling_status(::metrics::SystemProfileProto_ClientSideSamplingStatus value) {
  ...
  _impl_._has_bits_[1] |= 0x00000001u;
  _impl_.client_side_sampling_status_ = value;
}
...
inline void SystemProfileProto::clear_metrics_filtering_status() {
  _impl_.metrics_filtering_status_ = 0;
...
inline ::metrics::SystemProfileProto_MetricsFilteringStatus SystemProfileProto::_internal_metrics_filtering_status() const {
  return static_cast< ::metrics::SystemProfileProto_MetricsFilteringStatus >(_impl_.metrics_filtering_status_);
}
...
inline void SystemProfileProto::_internal_set_metrics_filtering_status(::metrics::SystemProfileProto_MetricsFilteringStatus value) {
  ...
  _impl_._has_bits_[1] |= 0x00000002u;
  _impl_.metrics_filtering_status_ = value;
}
...
inline void SystemProfileProto::clear_installer_package() {
  _impl_.installer_package_ = 0;
  _impl_._has_bits_[0] &= ~0x20000000u;
}
inline ::metrics::SystemProfileProto_InstallerPackage SystemProfileProto::_internal_installer_package() const {
  return static_cast< ::metrics::SystemProfileProto_InstallerPackage >(_impl_.installer_package_);
}
...
inline void SystemProfileProto::_internal_set_installer_package(::metrics::SystemProfileProto_InstallerPackage value) {
  ...
  _impl_._has_bits_[0] |= 0x20000000u;
  _impl_.installer_package_ = value;
}
...
inline bool SystemProfileProto::_internal_has_linked_android_phone_data() const {
  bool value = (_impl_._has_bits_[0] & 0x00002000u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.linked_android_phone_data_ != nullptr);
  return value;
}
...
inline void SystemProfileProto::clear_linked_android_phone_data() {
  if (_impl_.linked_android_phone_data_ != nullptr) _impl_.linked_android_phone_data_->Clear();
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline const ::metrics::SystemProfileProto_LinkedAndroidPhoneData& SystemProfileProto::_internal_linked_android_phone_data() const {
  const ::metrics::SystemProfileProto_LinkedAndroidPhoneData* p = _impl_.linked_android_phone_data_;
...
inline void SystemProfileProto::unsafe_arena_set_allocated_linked_android_phone_data(
    ::metrics::SystemProfileProto_LinkedAndroidPhoneData* linked_android_phone_data) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.linked_android_phone_data_);
  }
  _impl_.linked_android_phone_data_ = linked_android_phone_data;
...
inline ::metrics::SystemProfileProto_LinkedAndroidPhoneData* SystemProfileProto::release_linked_android_phone_data() {
  _impl_._has_bits_[0] &= ~0x00002000u;
  ::metrics::SystemProfileProto_LinkedAndroidPhoneData* temp = _impl_.linked_android_phone_data_;
  _impl_.linked_android_phone_data_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::metrics::SystemProfileProto_LinkedAndroidPhoneData* SystemProfileProto::_internal_mutable_linked_android_phone_data() {
  _impl_._has_bits_[0] |= 0x00002000u;
  if (_impl_.linked_android_phone_data_ == nullptr) {
    auto* p = CreateMaybeMessage<::metrics::SystemProfileProto_LinkedAndroidPhoneData>(GetArenaForAllocation());
    _impl_.linked_android_phone_data_ = p;
  }
  return _impl_.linked_android_phone_data_;
}
...
inline void SystemProfileProto::set_allocated_linked_android_phone_data(::metrics::SystemProfileProto_LinkedAndroidPhoneData* linked_android_phone_data) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.linked_android_phone_data_;
  }
  if (linked_android_phone_data) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
inline const ::metrics::SystemProfileProto_DemoModeDimensions& SystemProfileProto::_internal_demo_mode_dimensions() const {
  const ::metrics::SystemProfileProto_DemoModeDimensions* p = _impl_.demo_mode_dimensions_;
...
inline ::metrics::SystemProfileProto_DemoModeDimensions* SystemProfileProto::release_demo_mode_dimensions() {
  _impl_._has_bits_[0] &= ~0x00008000u;
  ::metrics::SystemProfileProto_DemoModeDimensions* temp = _impl_.demo_mode_dimensions_;
...
inline void SystemProfileProto::clear_lts_channel() {
  _impl_.lts_channel_ = 0;
  _impl_._has_bits_[1] &= ~0x00000008u;
}
inline ::metrics::SystemProfileProto_LTSChannel SystemProfileProto::_internal_lts_channel() const {
  return static_cast< ::metrics::SystemProfileProto_LTSChannel >(_impl_.lts_channel_);
}
...
// optional .metrics.SystemProfileProto.TpmIdentifier tpm_identifier = 47;
inline bool SystemProfileProto::_internal_has_tpm_identifier() const {
  bool value = (_impl_._has_bits_[0] & 0x00010000u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.tpm_identifier_ != nullptr);
  return value;
}
inline bool SystemProfileProto::has_tpm_identifier() const {
  return _internal_has_tpm_identifier();
}
inline void SystemProfileProto::clear_tpm_identifier() {
  if (_impl_.tpm_identifier_ != nullptr) _impl_.tpm_identifier_->Clear();
  _impl_._has_bits_[0] &= ~0x00010000u;
}
inline const ::metrics::SystemProfileProto_TpmIdentifier& SystemProfileProto::_internal_tpm_identifier() const {
  const ::metrics::SystemProfileProto_TpmIdentifier* p = _impl_.tpm_identifier_;
  return p != nullptr ? *p : reinterpret_cast<const ::metrics::SystemProfileProto_TpmIdentifier&>(
      ::metrics::_SystemProfileProto_TpmIdentifier_default_instance_);
}
inline const ::metrics::SystemProfileProto_TpmIdentifier& SystemProfileProto::tpm_identifier() const {
  // @@protoc_insertion_point(field_get:metrics.SystemProfileProto.tpm_identifier)
  return _internal_tpm_identifier();
}
inline void SystemProfileProto::unsafe_arena_set_allocated_tpm_identifier(
    ::metrics::SystemProfileProto_TpmIdentifier* tpm_identifier) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.tpm_identifier_);
  }
  _impl_.tpm_identifier_ = tpm_identifier;
  if (tpm_identifier) {
    _impl_._has_bits_[0] |= 0x00010000u;
  } else {
    _impl_._has_bits_[0] &= ~0x00010000u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:metrics.SystemProfileProto.tpm_identifier)
}
inline ::metrics::SystemProfileProto_TpmIdentifier* SystemProfileProto::release_tpm_identifier() {
  _impl_._has_bits_[0] &= ~0x00010000u;
  ::metrics::SystemProfileProto_TpmIdentifier* temp = _impl_.tpm_identifier_;
  _impl_.tpm_identifier_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::metrics::SystemProfileProto_TpmIdentifier* SystemProfileProto::unsafe_arena_release_tpm_identifier() {
  // @@protoc_insertion_point(field_release:metrics.SystemProfileProto.tpm_identifier)
  _impl_._has_bits_[0] &= ~0x00010000u;
  ::metrics::SystemProfileProto_TpmIdentifier* temp = _impl_.tpm_identifier_;
  _impl_.tpm_identifier_ = nullptr;
  return temp;
}
inline ::metrics::SystemProfileProto_TpmIdentifier* SystemProfileProto::_internal_mutable_tpm_identifier() {
  _impl_._has_bits_[0] |= 0x00010000u;
  if (_impl_.tpm_identifier_ == nullptr) {
    auto* p = CreateMaybeMessage<::metrics::SystemProfileProto_TpmIdentifier>(GetArenaForAllocation());
    _impl_.tpm_identifier_ = p;
  }
  return _impl_.tpm_identifier_;
}
inline ::metrics::SystemProfileProto_TpmIdentifier* SystemProfileProto::mutable_tpm_identifier() {
  ::metrics::SystemProfileProto_TpmIdentifier* _msg = _internal_mutable_tpm_identifier();
  // @@protoc_insertion_point(field_mutable:metrics.SystemProfileProto.tpm_identifier)
  return _msg;
}
inline void SystemProfileProto::set_allocated_tpm_identifier(::metrics::SystemProfileProto_TpmIdentifier* tpm_identifier) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.tpm_identifier_;
  }
  if (tpm_identifier) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(tpm_identifier);
    if (message_arena != submessage_arena) {
      tpm_identifier = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, tpm_identifier, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00010000u;
  } else {
    _impl_._has_bits_[0] &= ~0x00010000u;
  ...
  _impl_.tpm_identifier_ = tpm_identifier;
  // @@protoc_insertion_point(field_set_allocated:metrics.SystemProfileProto.tpm_identifier)
}
