...
PROTOBUF_CONSTEXPR ExtensionInstallProto::ExtensionInstallProto(
  ...
  , /*decltype(_impl_.disable_reasons_)*/{}
  , /*decltype(_impl_.type_)*/0
  , /*decltype(_impl_.install_location_)*/0
  , /*decltype(_impl_.manifest_version_)*/0
  , /*decltype(_impl_.action_type_)*/0
  , /*decltype(_impl_.has_file_access_)*/false
  , /*decltype(_impl_.has_incognito_access_)*/false
  , /*decltype(_impl_.is_from_store_)*/false
  , /*decltype(_impl_.updates_from_store_)*/false
  , /*decltype(_impl_.is_from_bookmark_)*/false
  , /*decltype(_impl_.is_converted_from_user_script_)*/false
  , /*decltype(_impl_.is_default_installed_)*/false
  , /*decltype(_impl_.is_oem_installed_)*/false
  , /*decltype(_impl_.background_script_type_)*/0
  , /*decltype(_impl_.blacklist_state_)*/0
  , /*decltype(_impl_.installed_in_this_sample_period_)*/false
  , /*decltype(_impl_.in_extensions_developer_mode_)*/false} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExtensionInstallProtoDefaultTypeInternal _ExtensionInstallProto_default_instance_;
}  // namespace metrics
namespace metrics {
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> ExtensionInstallProto_DisableReason_strings[20] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry ExtensionInstallProto_DisableReason_entries[] = {
  ...
  { {ExtensionInstallProto_DisableReason_names + 243, 31}, 21 },
  { {ExtensionInstallProto_DisableReason_names + 274, 28}, 20 },
  { {ExtensionInstallProto_DisableReason_names + 302, 23}, 3 },
  { {ExtensionInstallProto_DisableReason_names + 325, 25}, 11 },
  { {ExtensionInstallProto_DisableReason_names + 350, 11}, 0 },
};
...
static const int ExtensionInstallProto_DisableReason_entries_by_number[] = {
  ...
  18, // 11 -> UPDATE_REQUIRED_BY_POLICY
  ...
  16, // 20 -> UNSUPPORTED_MANIFEST_VERSION
  15, // 21 -> UNSUPPORTED_DEVELOPER_EXTENSION
};
...
const std::string& ExtensionInstallProto_DisableReason_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          20, ExtensionInstallProto_DisableReason_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      ExtensionInstallProto_DisableReason_entries,
      ExtensionInstallProto_DisableReason_entries_by_number,
...
bool ExtensionInstallProto_DisableReason_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      ExtensionInstallProto_DisableReason_entries, 20, name, &int_value);
  if (success) {
...
constexpr ExtensionInstallProto_DisableReason ExtensionInstallProto::UNSUPPORTED_MANIFEST_VERSION;
constexpr ExtensionInstallProto_DisableReason ExtensionInstallProto::UNSUPPORTED_DEVELOPER_EXTENSION;
...
class ExtensionInstallProto::_Internal {
 public:
  ...
  static void set_has_in_extensions_developer_mode(HasBits* has_bits) {
    (*has_bits)[0] |= 32768u;
  }
};
...
ExtensionInstallProto::ExtensionInstallProto(const ExtensionInstallProto& from)
  ...
  ExtensionInstallProto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.disable_reasons_){from._impl_.disable_reasons_}
    , decltype(_impl_.type_){}
    , decltype(_impl_.install_location_){}
    , decltype(_impl_.manifest_version_){}
    , decltype(_impl_.action_type_){}
    , decltype(_impl_.has_file_access_){}
    , decltype(_impl_.has_incognito_access_){}
    , decltype(_impl_.is_from_store_){}
    , decltype(_impl_.updates_from_store_){}
    , decltype(_impl_.is_from_bookmark_){}
    , decltype(_impl_.is_converted_from_user_script_){}
    , decltype(_impl_.is_default_installed_){}
    , decltype(_impl_.is_oem_installed_){}
    , decltype(_impl_.background_script_type_){}
    , decltype(_impl_.blacklist_state_){}
    , decltype(_impl_.installed_in_this_sample_period_){}
    , decltype(_impl_.in_extensions_developer_mode_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.type_, &from._impl_.type_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.in_extensions_developer_mode_) -
    reinterpret_cast<char*>(&_impl_.type_)) + sizeof(_impl_.in_extensions_developer_mode_));
...
inline void ExtensionInstallProto::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.disable_reasons_){arena}
    , decltype(_impl_.type_){0}
    , decltype(_impl_.install_location_){0}
    , decltype(_impl_.manifest_version_){0}
    , decltype(_impl_.action_type_){0}
...
inline void ExtensionInstallProto::SharedDtor() {
  ...
  _impl_.disable_reasons_.~RepeatedField();
}
...
// @@protoc_insertion_point(message_clear_start:metrics.ExtensionInstallProto)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&_impl_.type_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.updates_from_store_) -
        reinterpret_cast<char*>(&_impl_.type_)) + sizeof(_impl_.updates_from_store_));
  }
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&_impl_.is_from_bookmark_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.in_extensions_developer_mode_) -
        reinterpret_cast<char*>(&_impl_.is_from_bookmark_)) + sizeof(_impl_.in_extensions_developer_mode_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          _impl_.has_file_access_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          _impl_.has_incognito_access_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          _impl_.is_from_bookmark_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 128)) {
          ...
          _impl_.installed_in_this_sample_period_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 17:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 136)) {
          _Internal::set_has_in_extensions_developer_mode(&has_bits);
          _impl_.in_extensions_developer_mode_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ExtensionInstallProto::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00008000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(17, this->_internal_in_extensions_developer_mode(), target);
  }
...
void ExtensionInstallProto::MergeFrom(const ExtensionInstallProto& from) {
  ...
  _this->_impl_.disable_reasons_.MergeFrom(from._impl_.disable_reasons_);
