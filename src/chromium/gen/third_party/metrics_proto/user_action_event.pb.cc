...
UserActionEventProto::UserActionEventProto(const UserActionEventProto& from)
  ...
  ::memcpy(&_impl_.name_hash_, &from._impl_.name_hash_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.time_sec_) -
    reinterpret_cast<char*>(&_impl_.name_hash_)) + sizeof(_impl_.time_sec_));
...
void UserActionEventProto::InternalSwap(UserActionEventProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(UserActionEventProto, _impl_.time_sec_)
      + sizeof(UserActionEventProto::_impl_.time_sec_)
