...
PROTOBUF_CONSTEXPR ChromeOSAppListLaunchEventProto::ChromeOSAppListLaunchEventProto(
  ...
  , /*decltype(_impl_.recurrence_ranker_user_id_)*/uint64_t{0u}
  , /*decltype(_impl_.launch_type_)*/0
  , /*decltype(_impl_.hour_)*/0
  , /*decltype(_impl_.hashed_target_)*/uint64_t{0u}
  , /*decltype(_impl_.hashed_query_)*/uint64_t{0u}
  , /*decltype(_impl_.search_query_length_)*/0
  , /*decltype(_impl_.search_provider_type_)*/0
  , /*decltype(_impl_.hashed_domain_)*/uint64_t{0u}
  , /*decltype(_impl_.hashed_app_)*/uint64_t{0u}} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeOSAppListLaunchEventProtoDefaultTypeInternal _ChromeOSAppListLaunchEventProto_default_instance_;
}  // namespace metrics
namespace metrics {
...
class ChromeOSAppListLaunchEventProto::_Internal {
 public:
  using HasBits = decltype(std::declval<ChromeOSAppListLaunchEventProto>()._impl_._has_bits_);
...
ChromeOSAppListLaunchEventProto::ChromeOSAppListLaunchEventProto(const ChromeOSAppListLaunchEventProto& from)
  ...
  ChromeOSAppListLaunchEventProto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.recurrence_ranker_user_id_){}
    , decltype(_impl_.launch_type_){}
    , decltype(_impl_.hour_){}
    , decltype(_impl_.hashed_target_){}
    , decltype(_impl_.hashed_query_){}
    , decltype(_impl_.search_query_length_){}
    , decltype(_impl_.search_provider_type_){}
    , decltype(_impl_.hashed_domain_){}
    , decltype(_impl_.hashed_app_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.recurrence_ranker_user_id_, &from._impl_.recurrence_ranker_user_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.hashed_app_) -
    reinterpret_cast<char*>(&_impl_.recurrence_ranker_user_id_)) + sizeof(_impl_.hashed_app_));
...
// @@protoc_insertion_point(message_clear_start:metrics.ChromeOSAppListLaunchEventProto)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&_impl_.recurrence_ranker_user_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.hashed_domain_) -
        reinterpret_cast<char*>(&_impl_.recurrence_ranker_user_id_)) + sizeof(_impl_.hashed_domain_));
  }
  _impl_.hashed_app_ = uint64_t{0u};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 9)) {
          ...
          _impl_.recurrence_ranker_user_id_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<uint64_t>(ptr);
          ptr += sizeof(uint64_t);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          _impl_.search_query_length_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 41)) {
          ...
          _impl_.hashed_target_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<uint64_t>(ptr);
          ptr += sizeof(uint64_t);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 49)) {
          ...
          _impl_.hashed_query_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<uint64_t>(ptr);
          ptr += sizeof(uint64_t);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 57)) {
          ...
          _impl_.hashed_domain_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<uint64_t>(ptr);
          ptr += sizeof(uint64_t);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 65)) {
          ...
          _impl_.hashed_app_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<uint64_t>(ptr);
          ptr += sizeof(uint64_t);
        } else
          goto handle_unusual;
        continue;
...
void ChromeOSAppListLaunchEventProto::MergeFrom(const ChromeOSAppListLaunchEventProto& from) {
  ChromeOSAppListLaunchEventProto* const _this = this;
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.recurrence_ranker_user_id_ = from._impl_.recurrence_ranker_user_id_;
    }
    if (cached_has_bits & 0x00000002u) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.hashed_target_ = from._impl_.hashed_target_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.hashed_query_ = from._impl_.hashed_query_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.search_query_length_ = from._impl_.search_query_length_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.search_provider_type_ = from._impl_.search_provider_type_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.hashed_domain_ = from._impl_.hashed_domain_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_hashed_app(from._internal_hashed_app());
  }
...
void ChromeOSAppListLaunchEventProto::InternalSwap(ChromeOSAppListLaunchEventProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChromeOSAppListLaunchEventProto, _impl_.hashed_app_)
      + sizeof(ChromeOSAppListLaunchEventProto::_impl_.hashed_app_)
      - PROTOBUF_FIELD_OFFSET(ChromeOSAppListLaunchEventProto, _impl_.recurrence_ranker_user_id_)>(
          reinterpret_cast<char*>(&_impl_.recurrence_ranker_user_id_),
          reinterpret_cast<char*>(&other->_impl_.recurrence_ranker_user_id_));
}
