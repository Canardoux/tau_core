...
PROTOBUF_CONSTEXPR SampledProfile::SampledProfile(
  ...
  , /*decltype(_impl_.process_types_)*/{}
  , /*decltype(_impl_.thread_types_)*/{}
  , /*decltype(_impl_.cpu_max_frequency_mhz_)*/{}
  , /*decltype(_impl_.lacros_pids_)*/{}
  , /*decltype(_impl_._lacros_pids_cached_byte_size_)*/{0}
  , /*decltype(_impl_.lacros_version_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.perf_data_)*/nullptr
  , /*decltype(_impl_.call_stack_profile_)*/nullptr
  , /*decltype(_impl_.perf_stat_)*/nullptr
  , /*decltype(_impl_.ms_after_boot_)*/int64_t{0}
  , /*decltype(_impl_.ms_after_login_)*/int64_t{0}
  , /*decltype(_impl_.trigger_event_)*/0
  , /*decltype(_impl_.num_tabs_restored_)*/0
  , /*decltype(_impl_.suspend_duration_ms_)*/int64_t{0}
  , /*decltype(_impl_.ms_after_resume_)*/int64_t{0}
  , /*decltype(_impl_.ms_after_restore_)*/int64_t{0}
  , /*decltype(_impl_.process_)*/0
  , /*decltype(_impl_.thread_)*/0
  , /*decltype(_impl_.psi_cpu_last_10s_pct_)*/0
  , /*decltype(_impl_.psi_cpu_last_60s_pct_)*/0
  , /*decltype(_impl_.lacros_channel_)*/0
  , /*decltype(_impl_.thermal_state_)*/0
  , /*decltype(_impl_.cpu_speed_limit_percent_)*/0} {}
...
class SampledProfile::_Internal {
 public:
  using HasBits = decltype(std::declval<SampledProfile>()._impl_._has_bits_);
...
SampledProfile::SampledProfile(const SampledProfile& from)
  ...
  SampledProfile* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , /*decltype(_impl_.process_types_)*/{}
    , /*decltype(_impl_.thread_types_)*/{}
    , decltype(_impl_.cpu_max_frequency_mhz_){from._impl_.cpu_max_frequency_mhz_}
    , decltype(_impl_.lacros_pids_){from._impl_.lacros_pids_}
    , /*decltype(_impl_._lacros_pids_cached_byte_size_)*/{0}
    , decltype(_impl_.lacros_version_){}
    , decltype(_impl_.perf_data_){nullptr}
    , decltype(_impl_.call_stack_profile_){nullptr}
    , decltype(_impl_.perf_stat_){nullptr}
    , decltype(_impl_.ms_after_boot_){}
    , decltype(_impl_.ms_after_login_){}
    , decltype(_impl_.trigger_event_){}
    , decltype(_impl_.num_tabs_restored_){}
    , decltype(_impl_.suspend_duration_ms_){}
    , decltype(_impl_.ms_after_resume_){}
    , decltype(_impl_.ms_after_restore_){}
    , decltype(_impl_.process_){}
    , decltype(_impl_.thread_){}
    , decltype(_impl_.psi_cpu_last_10s_pct_){}
    , decltype(_impl_.psi_cpu_last_60s_pct_){}
    , decltype(_impl_.lacros_channel_){}
    , decltype(_impl_.thermal_state_){}
    , decltype(_impl_.cpu_speed_limit_percent_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  _this->_impl_.process_types_.MergeFrom(from._impl_.process_types_);
  _this->_impl_.thread_types_.MergeFrom(from._impl_.thread_types_);
  _impl_.lacros_version_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.lacros_version_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_lacros_version()) {
    _this->_impl_.lacros_version_.Set(from._internal_lacros_version(), 
      _this->GetArenaForAllocation());
  }
  if (from._internal_has_perf_data()) {
    _this->_impl_.perf_data_ = new ::metrics::PerfDataProto(*from._impl_.perf_data_);
  }
  if (from._internal_has_call_stack_profile()) {
    _this->_impl_.call_stack_profile_ = new ::metrics::CallStackProfile(*from._impl_.call_stack_profile_);
  }
  if (from._internal_has_perf_stat()) {
    _this->_impl_.perf_stat_ = new ::metrics::PerfStatProto(*from._impl_.perf_stat_);
  }
  ::memcpy(&_impl_.ms_after_boot_, &from._impl_.ms_after_boot_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.cpu_speed_limit_percent_) -
    reinterpret_cast<char*>(&_impl_.ms_after_boot_)) + sizeof(_impl_.cpu_speed_limit_percent_));
...
inline void SampledProfile::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , /*decltype(_impl_.process_types_)*/{::_pbi::ArenaInitialized(), arena}
    , /*decltype(_impl_.thread_types_)*/{::_pbi::ArenaInitialized(), arena}
    , decltype(_impl_.cpu_max_frequency_mhz_){arena}
    , decltype(_impl_.lacros_pids_){arena}
    , /*decltype(_impl_._lacros_pids_cached_byte_size_)*/{0}
    , decltype(_impl_.lacros_version_){}
    , decltype(_impl_.perf_data_){nullptr}
    , decltype(_impl_.call_stack_profile_){nullptr}
...
inline void SampledProfile::SharedDtor() {
  ...
  _impl_.process_types_.Destruct();
  _impl_.process_types_.~MapFieldLite();
  _impl_.thread_types_.Destruct();
  _impl_.thread_types_.~MapFieldLite();
  _impl_.cpu_max_frequency_mhz_.~RepeatedField();
  _impl_.lacros_pids_.~RepeatedField();
  _impl_.lacros_version_.Destroy();
  if (this != internal_default_instance()) delete _impl_.perf_data_;
  if (this != internal_default_instance()) delete _impl_.call_stack_profile_;
  if (this != internal_default_instance()) delete _impl_.perf_stat_;
}
...
// @@protoc_insertion_point(message_clear_start:metrics.SampledProfile)
  ...
  _impl_.process_types_.Clear();
  _impl_.thread_types_.Clear();
  _impl_.cpu_max_frequency_mhz_.Clear();
  _impl_.lacros_pids_.Clear();
  cached_has_bits = _impl_._has_bits_[0];
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      _impl_.lacros_version_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000002u) {
      GOOGLE_DCHECK(_impl_.perf_data_ != nullptr);
      _impl_.perf_data_->Clear();
    }
    if (cached_has_bits & 0x00000004u) {
      GOOGLE_DCHECK(_impl_.call_stack_profile_ != nullptr);
      _impl_.call_stack_profile_->Clear();
    }
    if (cached_has_bits & 0x00000008u) {
      GOOGLE_DCHECK(_impl_.perf_stat_ != nullptr);
      _impl_.perf_stat_->Clear();
    }
  }
  if (cached_has_bits & 0x000000f0u) {
    ::memset(&_impl_.ms_after_boot_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.num_tabs_restored_) -
        reinterpret_cast<char*>(&_impl_.ms_after_boot_)) + sizeof(_impl_.num_tabs_restored_));
  }
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&_impl_.suspend_duration_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.lacros_channel_) -
        reinterpret_cast<char*>(&_impl_.suspend_duration_ms_)) + sizeof(_impl_.lacros_channel_));
  }
  if (cached_has_bits & 0x00030000u) {
    ::memset(&_impl_.thermal_state_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.cpu_speed_limit_percent_) -
        reinterpret_cast<char*>(&_impl_.thermal_state_)) + sizeof(_impl_.cpu_speed_limit_percent_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          _impl_.ms_after_boot_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          _impl_.ms_after_login_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          _impl_.suspend_duration_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          _impl_.ms_after_resume_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          _impl_.num_tabs_restored_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          ...
          _impl_.ms_after_restore_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 106)) {
          ...
          do {
            ptr += 1;
            auto object = ::PROTOBUF_NAMESPACE_ID::internal::InitEnumParseWrapper<std::string>(&_impl_.process_types_, ::metrics::Process_IsValid, 13, &_internal_metadata_);
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 114)) {
          ...
          do {
            ptr += 1;
            auto object = ::PROTOBUF_NAMESPACE_ID::internal::InitEnumParseWrapper<std::string>(&_impl_.thread_types_, ::metrics::Thread_IsValid, 14, &_internal_metadata_);
            ptr = ctx->ParseMessage(&object, ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 133)) {
          ...
          _impl_.psi_cpu_last_10s_pct_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 17:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 141)) {
          ...
          _impl_.psi_cpu_last_60s_pct_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 176)) {
          ...
          _impl_.cpu_speed_limit_percent_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SampledProfile::_InternalSerialize(
  ...
  // repeated uint32 lacros_pids = 18 [packed = true];
  {
    int byte_size = _impl_._lacros_pids_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
...
// @@protoc_insertion_point(message_byte_size_start:metrics.SampledProfile)
  ...
  // repeated uint32 cpu_max_frequency_mhz = 15;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt32Size(this->_impl_.cpu_max_frequency_mhz_);
    total_size += 1 *
  ...
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt32Size(this->_impl_.lacros_pids_);
    if (data_size > 0) {
      total_size += 2 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._lacros_pids_cached_byte_size_.store(cached_size,
...
void SampledProfile::MergeFrom(const SampledProfile& from) {
  SampledProfile* const _this = this;
  ...
  _this->_impl_.process_types_.MergeFrom(from._impl_.process_types_);
  _this->_impl_.thread_types_.MergeFrom(from._impl_.thread_types_);
  _this->_impl_.cpu_max_frequency_mhz_.MergeFrom(from._impl_.cpu_max_frequency_mhz_);
  _this->_impl_.lacros_pids_.MergeFrom(from._impl_.lacros_pids_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_lacros_version(from._internal_lacros_version());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_perf_data()->::metrics::PerfDataProto::MergeFrom(
          from._internal_perf_data());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_call_stack_profile()->::metrics::CallStackProfile::MergeFrom(
          from._internal_call_stack_profile());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_perf_stat()->::metrics::PerfStatProto::MergeFrom(
          from._internal_perf_stat());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.ms_after_boot_ = from._impl_.ms_after_boot_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.ms_after_login_ = from._impl_.ms_after_login_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.trigger_event_ = from._impl_.trigger_event_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.num_tabs_restored_ = from._impl_.num_tabs_restored_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x0000ff00u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.suspend_duration_ms_ = from._impl_.suspend_duration_ms_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.ms_after_resume_ = from._impl_.ms_after_resume_;
    }
    if (cached_has_bits & 0x00000400u) {
      _this->_impl_.ms_after_restore_ = from._impl_.ms_after_restore_;
    }
    if (cached_has_bits & 0x00000800u) {
    ...
    if (cached_has_bits & 0x00002000u) {
      _this->_impl_.psi_cpu_last_10s_pct_ = from._impl_.psi_cpu_last_10s_pct_;
    }
    if (cached_has_bits & 0x00004000u) {
      _this->_impl_.psi_cpu_last_60s_pct_ = from._impl_.psi_cpu_last_60s_pct_;
    }
    if (cached_has_bits & 0x00008000u) {
      _this->_impl_.lacros_channel_ = from._impl_.lacros_channel_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00030000u) {
    ...
    if (cached_has_bits & 0x00020000u) {
      _this->_impl_.cpu_speed_limit_percent_ = from._impl_.cpu_speed_limit_percent_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
...
void SampledProfile::InternalSwap(SampledProfile* other) {
  ...
  _impl_.process_types_.InternalSwap(&other->_impl_.process_types_);
  _impl_.thread_types_.InternalSwap(&other->_impl_.thread_types_);
  _impl_.cpu_max_frequency_mhz_.InternalSwap(&other->_impl_.cpu_max_frequency_mhz_);
  _impl_.lacros_pids_.InternalSwap(&other->_impl_.lacros_pids_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.lacros_version_, lhs_arena,
      &other->_impl_.lacros_version_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SampledProfile, _impl_.cpu_speed_limit_percent_)
      + sizeof(SampledProfile::_impl_.cpu_speed_limit_percent_)
      - PROTOBUF_FIELD_OFFSET(SampledProfile, _impl_.perf_data_)>(
          reinterpret_cast<char*>(&_impl_.perf_data_),
          reinterpret_cast<char*>(&other->_impl_.perf_data_));
}
