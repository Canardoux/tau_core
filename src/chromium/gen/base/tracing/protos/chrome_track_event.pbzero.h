...
constexpr WebViewStartup_CallSite WebViewStartup_CallSite_MAX = WebViewStartup_CallSite::ASYNC_WEBVIEW_STARTUP;
...
class AndroidChoreographerFrameCallbackData_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class AndroidChoreographerFrameCallbackData_FrameTimeline_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class CurrentTask_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class ChromeGraphicsPipeline_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
