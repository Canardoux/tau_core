...
#define GPU_DRIVER_BUG_WORKAROUNDS(GPU_OP)                                  \
  ...
  GPU_OP(AVOID_CONSECUTIVE_KEYFRAMES_FOR_VP9,                               \
  ...
  GPU_OP(DISABLE_CANVAS_OOP_RASTERIZATION,                                  \
  ...
  GPU_OP(DISABLE_DML_META_COMMANDS_FOR_GPU,                                 \
  ...
  GPU_OP(DISABLE_HALF_FLOAT_FOR_GMB,                                        \
  ...
  GPU_OP(USE_CURRENT_PICTURE_FOR_AV1_INVALID_REF,                           \
