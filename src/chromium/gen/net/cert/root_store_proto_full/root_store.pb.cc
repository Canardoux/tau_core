...
PROTOBUF_CONSTEXPR ConstraintSet::ConstraintSet(
  ...
  , /*decltype(_impl_.permitted_dns_names_)*/{}
  ...
  , /*decltype(_impl_.sct_not_after_sec_)*/int64_t{0}
...
PROTOBUF_CONSTEXPR TrustAnchor::TrustAnchor(
    ...
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.ev_policy_oids_)*/{}
...
PROTOBUF_CONSTEXPR RootStore::RootStore(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.trust_anchors_)*/{}
  , /*decltype(_impl_.version_major_)*/int64_t{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const ::_pbi::DescriptorTable descriptor_table_root_5fstore_2eproto = {
    false, false, 586, descriptor_table_protodef_root_5fstore_2eproto,
    "root_store.proto",
    &descriptor_table_root_5fstore_2eproto_once, nullptr, 0, 3,
...
ConstraintSet::ConstraintSet(const ConstraintSet& from)
  ...
  ConstraintSet* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.permitted_dns_names_){from._impl_.permitted_dns_names_}
    , decltype(_impl_.min_version_){}
    , decltype(_impl_.max_version_exclusive_){}
    , decltype(_impl_.sct_not_after_sec_){}
    , decltype(_impl_.sct_all_after_sec_){}};
  ...
  if (from._internal_has_max_version_exclusive()) {
    _this->_impl_.max_version_exclusive_.Set(from._internal_max_version_exclusive(), 
      _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.sct_not_after_sec_, &from._impl_.sct_not_after_sec_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.sct_all_after_sec_) -
    reinterpret_cast<char*>(&_impl_.sct_not_after_sec_)) + sizeof(_impl_.sct_all_after_sec_));
...
inline void ConstraintSet::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.permitted_dns_names_){arena}
    , decltype(_impl_.min_version_){}
    , decltype(_impl_.max_version_exclusive_){}
    , decltype(_impl_.sct_not_after_sec_){int64_t{0}}
    , decltype(_impl_.sct_all_after_sec_){int64_t{0}}
...
// @@protoc_insertion_point(message_clear_start:chrome_root_store.ConstraintSet)
  ...
  if (cached_has_bits & 0x0000000cu) {
    ::memset(&_impl_.sct_not_after_sec_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.sct_all_after_sec_) -
        reinterpret_cast<char*>(&_impl_.sct_not_after_sec_)) + sizeof(_impl_.sct_all_after_sec_));
  }
...
uint8_t* ConstraintSet::_InternalSerialize(
  ...
  if (_internal_has_min_version()) {
    ...
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_min_version(), target);
  }

  // optional string max_version_exclusive = 4;
  if (_internal_has_max_version_exclusive()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_max_version_exclusive().data(), static_cast<int>(this->_internal_max_version_exclusive().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "chrome_root_store.ConstraintSet.max_version_exclusive");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_max_version_exclusive(), target);
  }
  ...
  for (int i = 0, n = this->_internal_permitted_dns_names_size(); i < n; i++) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "chrome_root_store.ConstraintSet.permitted_dns_names");
...
// @@protoc_insertion_point(message_byte_size_start:chrome_root_store.ConstraintSet)
  ...
  // repeated string permitted_dns_names = 5;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.permitted_dns_names_.size());
  for (int i = 0, n = _impl_.permitted_dns_names_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.permitted_dns_names_.Get(i));
  }
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_max_version_exclusive());
    }
...
void ConstraintSet::InternalSwap(ConstraintSet* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.max_version_exclusive_, lhs_arena,
      &other->_impl_.max_version_exclusive_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ConstraintSet, _impl_.sct_all_after_sec_)
      + sizeof(ConstraintSet::_impl_.sct_all_after_sec_)
...
TrustAnchor::TrustAnchor(const TrustAnchor& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  TrustAnchor* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.ev_policy_oids_){from._impl_.ev_policy_oids_}
...
inline void TrustAnchor::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.ev_policy_oids_){arena}
...
// @@protoc_insertion_point(message_byte_size_start:chrome_root_store.TrustAnchor)
  ...
  // repeated string ev_policy_oids = 3;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.ev_policy_oids_.size());
  for (int i = 0, n = _impl_.ev_policy_oids_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.ev_policy_oids_.Get(i));
  }
...
RootStore::RootStore(const RootStore& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RootStore* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.trust_anchors_){from._impl_.trust_anchors_}
...
inline void RootStore::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.trust_anchors_){arena}
    , decltype(_impl_.version_major_){int64_t{0}}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
::PROTOBUF_NAMESPACE_ID::Metadata RootStore::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_root_5fstore_2eproto_getter, &descriptor_table_root_5fstore_2eproto_once,
      file_level_metadata_root_5fstore_2eproto[2]);
}
