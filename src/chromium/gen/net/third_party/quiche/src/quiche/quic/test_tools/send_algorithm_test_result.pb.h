...
_impl_._has_bits_[0] |= 0x00000001u;
_impl_.test_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
_impl_._has_bits_[0] &= ~0x00000001u;
auto* p = _impl_.test_name_.Release();
...
_impl_.test_name_.SetAllocated(test_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (_impl_.test_name_.IsDefault()) {
_impl_.test_name_.Set("", GetArenaForAllocation());
}
