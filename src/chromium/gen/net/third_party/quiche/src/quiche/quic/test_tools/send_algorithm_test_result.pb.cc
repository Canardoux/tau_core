...
PROTOBUF_CONSTEXPR SendAlgorithmTestResult::SendAlgorithmTestResult(
  ...
  , /*decltype(_impl_.test_name_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.random_seed_)*/uint64_t{0u}
  , /*decltype(_impl_.simulated_duration_micros_)*/int64_t{0}} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SendAlgorithmTestResultDefaultTypeInternal _SendAlgorithmTestResult_default_instance_;
}  // namespace quic
namespace quic {
...
class SendAlgorithmTestResult::_Internal {
 public:
  using HasBits = decltype(std::declval<SendAlgorithmTestResult>()._impl_._has_bits_);
...
SendAlgorithmTestResult::SendAlgorithmTestResult(const SendAlgorithmTestResult& from)
  ...
  SendAlgorithmTestResult* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.test_name_){}
    , decltype(_impl_.random_seed_){}
    , decltype(_impl_.simulated_duration_micros_){}};
  ...
  if (from._internal_has_test_name()) {
    _this->_impl_.test_name_.Set(from._internal_test_name(), 
      _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.random_seed_, &from._impl_.random_seed_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.simulated_duration_micros_) -
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          _impl_.simulated_duration_micros_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
