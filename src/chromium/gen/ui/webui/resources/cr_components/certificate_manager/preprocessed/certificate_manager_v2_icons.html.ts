...
div.innerHTML = getTrustedHTML`<cr-iconset name="certmanager" size="24">
  <svg>
    <defs>
    <!--
      copied from https://fonts.gstatic.com/s/i/short-term/release/googlesymbols/id_card/default/24px.svg
    -->
      <g id="card" viewBox="0 -960 960 960">
