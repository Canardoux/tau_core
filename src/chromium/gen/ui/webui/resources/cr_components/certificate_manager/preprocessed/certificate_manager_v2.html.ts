...
export function getTemplate() {
  return html`<!--_html_template_start_--><style include="cr-page-host-style cr-shared-style cr-nav-menu-item-style certificate-manager-style-v2">
  :host {
    display: flex;
...
<div id="container">
  ...
  <cr-page-selector id="main" attr-for-selected="path"
    ...
    <local-certs-section-v2 id="localCertSection"
        path$="[[pageEnum_.LOCAL_CERTS]]" on-hash-copied="onHashCopied_">
    </local-certs-section-v2>
    ...
    <certificate-subpage-v2 id="userCertsSection"
