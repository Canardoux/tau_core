...
import { getCss as getCrIconsLit } from '../cr_icons_lit.css.js';
import { getCss as getCrSharedStyleLit } from '../cr_shared_style_lit.css.js';
import { getCss as getCrSpinnerStyleLit } from '../cr_spinner_style_lit.css.js';
let instance = null;
export function getCss() {
    return instance || (instance = [...[getCrSharedStyleLit(), getCrIconsLit(), getCrSpinnerStyleLit()], css `
:host {
  display: block;
  height: 40px;
  isolation: isolate;
