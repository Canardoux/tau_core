...
export class CrInfiniteListElement extends CrLitElement {
    constructor() {
        super(...arguments);
        this.scrollOffset = 0;
        this.scrollTarget = this;
        this.usingDefaultScrollTarget = true;
        this.items = [];
        this.itemSize = 100;
    ...
    updateFocusedItem_() {
        this.focusedItem_ = this.focusedIndex === -1 ?
            null :
            this.querySelector(`cr-lazy-list > *:nth-child(${this.focusedIndex + 1})`);
    }
    async onItemFocus_(e) {
