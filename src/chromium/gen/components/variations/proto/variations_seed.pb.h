...
class VariationsSeed final :
 ...
 public:
  ...
  protected:
  explicit VariationsSeed(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::variations::Layer >*
      mutable_layers();
  private:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::variations::Layer >&
      layers() const;
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  PROTOBUF_DEPRECATED void set_country_code(ArgT0&& arg0, ArgT... args);
