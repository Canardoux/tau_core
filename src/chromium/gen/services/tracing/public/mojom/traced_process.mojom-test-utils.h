// services/tracing/public/mojom/traced_process.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class COMPONENT_EXPORT(TRACING_MOJOM) TracedProcessInterceptorForTesting : public TracedProcess {
  ...
  void ConnectToTracingService(ConnectToTracingRequestPtr request, ConnectToTracingServiceCallback callback) override;
};
class COMPONENT_EXPORT(TRACING_MOJOM) TracedProcessAsyncWaiter {
 public:
  explicit TracedProcessAsyncWaiter(TracedProcess* proxy);

  TracedProcessAsyncWaiter(const TracedProcessAsyncWaiter&) = delete;
  TracedProcessAsyncWaiter& operator=(const TracedProcessAsyncWaiter&) = delete;
