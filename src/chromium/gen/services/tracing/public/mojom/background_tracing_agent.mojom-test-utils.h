...
class COMPONENT_EXPORT(TRACING_MOJOM) BackgroundTracingAgentInterceptorForTesting : public BackgroundTracingAgent {
  ...
  void SetUMACallback(BackgroundTracingRulePtr rule, const std::string& histogram_name, int32_t histogram_lower_value, int32_t histogram_upper_value) override;
