...
static_assert(sizeof(DataSourceConfig_Data) == 80,
...
static_assert(sizeof(IncrementalStateConfig_Data) == 16,
              "Bad sizeof(IncrementalStateConfig_Data)");
...
struct IncrementalStateConfig_UnserializedMessageContext
 ...
 public:
  ...
  IncrementalStateConfig_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
static_assert(sizeof(TraceConfig_Data) == 64,
