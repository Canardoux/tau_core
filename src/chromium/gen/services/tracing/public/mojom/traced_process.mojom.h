...
#include "services/tracing/public/mojom/traced_process.mojom-features.h"  // IWYU pragma: export
#include "services/tracing/public/mojom/traced_process.mojom-shared.h"  // IWYU pragma: export
#include "services/tracing/public/mojom/traced_process.mojom-forward.h"  // IWYU pragma: export
...
// with not having this data in traces there.
  ...
  struct ConnectToTracingService_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
#endif // !BUILDFLAG(IS_FUCHSIA)
  virtual ~TracedProcess() = default;
...
class TracedProcessStub
 ...
 public:
  ...
  TracedProcessStub() = default;
  ~TracedProcessStub() override = default;
...
ConnectToTracingRequest(const ConnectToTracingRequest&) = delete;
ConnectToTracingRequest& operator=(const ConnectToTracingRequest&) = delete;
...
template <typename T, ConnectToTracingRequest::EnableIfSame<T>*>
bool operator<(const T& lhs, const T& rhs) {
  if (lhs.perfetto_service < rhs.perfetto_service)
    return true;
  if (rhs.perfetto_service < lhs.perfetto_service)
    return false;
  return false;
}
