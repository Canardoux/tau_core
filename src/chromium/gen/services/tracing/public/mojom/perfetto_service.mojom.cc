...
void ProducerHostProxy::CommitData(
  ...
  mojo::Message message(
      base::to_underlying(messages::ProducerHost::kCommitData), kFlags, estimated_payload_size);
...
void ProducerHostProxy::RegisterDataSource(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerHost::kRegisterDataSource), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerHostProxy::RegisterTraceWriter(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerHost::kRegisterTraceWriter), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerHostProxy::UnregisterTraceWriter(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerHost::kUnregisterTraceWriter), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerClientProxy::OnTracingStart(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerClient::kOnTracingStart), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerClientProxy::StartDataSource(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerClient::kStartDataSource), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerClientProxy::StopDataSource(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerClient::kStopDataSource), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerClientProxy::Flush(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerClient::kFlush), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProducerClientProxy::ClearIncrementalState(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ProducerClient::kClearIncrementalState), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PerfettoServiceProxy::ConnectToProducerHost(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::PerfettoService::kConnectToProducerHost), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
uint32_t ConsumerHost::CloneSession_Sym::IPCStableHash() {
  ...
  // hash instead of __LINE__.
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)tracing::mojom::ConsumerHost::CloneSession");
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void ConsumerHostProxy::EnableTracing(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ConsumerHost::kEnableTracing), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ConsumerHostProxy::CloneSession(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::ConsumerHost::kCloneSession), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  mojo::internal::Serialize<::mojo_base::mojom::UnguessableTokenDataView>(
      in_unguessable_name, unguessable_name_fragment);
...
void TracingSessionHostProxy::ChangeTraceConfig(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionHost::kChangeTraceConfig), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionHostProxy::DisableTracing(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionHost::kDisableTracing), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionHostProxy::ReadBuffers(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionHost::kReadBuffers), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionHostProxy::RequestBufferUsage(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionHost::kRequestBufferUsage), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionHostProxy::DisableTracingAndEmitJson(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionHost::kDisableTracingAndEmitJson), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionClientProxy::OnTracingEnabled(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionClient::kOnTracingEnabled), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionClientProxy::OnTracingDisabled(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      base::to_underlying(messages::TracingSessionClient::kOnTracingDisabled), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TracingSessionHostInterceptorForTesting::DisableTracingAndEmitJson(const std::string& agent_label_filter, ::mojo::ScopedDataPipeProducerHandle stream, bool privacy_filtering_enabled, DisableTracingAndEmitJsonCallback callback) {
  GetForwardingInterface()->DisableTracingAndEmitJson(
    ...
    std::move(stream)
    , 
    std::move(privacy_filtering_enabled)
    , std::move(callback));
}
