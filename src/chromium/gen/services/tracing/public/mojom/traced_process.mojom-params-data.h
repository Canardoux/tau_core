...
class COMPONENT_EXPORT(TRACING_MOJOM_SHARED) TracedProcess_ConnectToTracingService_Params_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<TracedProcess_ConnectToTracingService_Params_Data>;
...
class COMPONENT_EXPORT(TRACING_MOJOM_SHARED) TracedProcess_ConnectToTracingService_ResponseParams_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<TracedProcess_ConnectToTracingService_ResponseParams_Data>;
...
class TracedProcess_ConnectToTracingService_ParamsDataView {
 public:
  TracedProcess_ConnectToTracingService_ParamsDataView() = default;
...
class TracedProcess_ConnectToTracingService_ResponseParamsDataView {
 public:
  TracedProcess_ConnectToTracingService_ResponseParamsDataView() = default;
...
inline void TracedProcess_ConnectToTracingService_ParamsDataView::GetRequestDataView(
    ConnectToTracingRequestDataView* output) {
  auto pointer = data_->request.Get();
  *output = ConnectToTracingRequestDataView(pointer, message_);
}
